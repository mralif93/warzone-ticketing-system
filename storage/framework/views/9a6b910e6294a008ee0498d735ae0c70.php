<?php $__env->startSection('title', 'Purchase Successful - ' . $event->name); ?>
<?php $__env->startSection('description', 'Your ticket purchase has been completed successfully. Thank you for choosing Warzone World Championship!'); ?>
...
<div class="min-h-screen bg-gradient-to-br from-green-50 to-emerald-100 py-8">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white rounded-2xl shadow-xl border border-gray-200 overflow-hidden mb-8">
                ...
                <div class="flex items-center justify-between">
                    <div class="flex items-center">
                        ...
                        <div>
                            ...
                            <p class="text-white/90 text-sm">Order #<?php echo e($order->id); ?> • <?php echo e($order->created_at->format('M d, Y \a\t g:i A')); ?></p>
                        </div>
                    </div>
                    <div class="text-right">
                        <div class="text-3xl font-bold text-white">RM<?php echo e(number_format($originalSubtotal - $comboDiscountAmount + ($serviceFeePercentage == 0 ? 0 : $order->service_fee) + ($taxPercentage == 0 ? 0 : $order->tax_amount), 2)); ?></div>
                        <div class="text-white/80 text-sm"><?php echo e($totalQuantity); ?> <?php echo e($totalQuantity > 1 ? 'tickets' : 'ticket'); ?></div>
                    </div>
                </div>
            </div>
            ...
            <div class="p-8">
                    ...
                    <div class="bg-gray-50 rounded-lg p-6">
                        <div class="flex items-center justify-between mb-4">
                            <div>
                                ...
                                <p class="text-gray-600"><?php echo e($event->venue); ?></p>
                            </div>
                            <div class="text-right">
                ...
                <div class="mb-8">
                    ...
                    <div class="space-y-4">
                        <?php $__currentLoopData = $tickets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ticketData): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php
                            ...
                            <div class="py-4 border-t border-gray-200">
                                <div class="flex items-center justify-between mb-2">
                                    <div class="flex items-center">
                                        ...
                                        <div>
                                            <h4 class="text-lg font-bold text-gray-900"><?php echo e($ticket->name); ?> <span class="text-sm text-gray-600">x <?php echo e($quantity); ?></span></h4>
                                        </div>
                                    </div>
                                    <div class="text-right">
                                        <span class="text-lg font-bold text-gray-900">RM<?php echo e(number_format($price * $quantity, 2)); ?></span>
                                    </div>
                                </div>
                                <div class="flex items-center justify-between">
                                    <div class="text-sm text-gray-600 ml-11">
                                        <?php if($dayName): ?>
                                            <?php echo e($dayName); ?> - <?php echo e($event->getEventDays()[$day-1]['display'] ?? ''); ?>

                                        <?php else: ?>
                                            <?php if($event->isMultiDay()): ?>
                                                <?php echo e($event->getEventDays()[0]['day_name']); ?> - <?php echo e($event->getEventDays()[0]['display']); ?>
                                    ...
                                    <div class="text-sm text-gray-600">RM<?php echo e(number_format($price, 2)); ?> each</div>
                                </div>
                            </div>
                ...
                <div class="bg-gray-50 rounded-lg p-6">
                    ...
                    <div class="space-y-2">
                        <div class="flex items-center justify-between py-1">
                            ...
                            <span class="font-bold text-gray-900 text-sm">RM<?php echo e(number_format($originalSubtotal, 2)); ?></span>
                        </div>
                        <div class="flex items-center justify-between py-1">
                            <div class="flex items-center">
                                ...
                                <span class="text-gray-700 font-medium text-sm">Combo Discount (<?php echo e(number_format($event->getComboDiscountPercentage(), 2)); ?>%)</span>
                            </div>
                            <span class="text-green-700 font-bold text-sm">-RM<?php echo e(number_format($comboDiscountAmount, 2)); ?></span>
                        </div>
                        <div class="flex items-center justify-between py-1">
                            <div class="flex items-center">
                            ...
                            <span class="font-bold text-gray-900 text-sm">RM<?php echo e(number_format($serviceFeePercentage == 0 ? 0 : $order->service_fee, 2)); ?></span>
                        </div>
                        <div class="flex items-center justify-between py-1">
                            <div class="flex items-center">
                            ...
                            <span class="font-bold text-gray-900 text-sm">RM<?php echo e(number_format($taxPercentage == 0 ? 0 : $order->tax_amount, 2)); ?></span>
                        </div>
                        <div class="flex items-center justify-between pt-2 border-t border-gray-400">
                            ...
                            <span class="font-bold text-red-600 text-sm">RM<?php echo e(number_format($originalSubtotal - $comboDiscountAmount + ($serviceFeePercentage == 0 ? 0 : $order->service_fee) + ($taxPercentage == 0 ? 0 : $order->tax_amount), 2)); ?></span>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="flex flex-col sm:flex-row justify-center gap-4 px-2">
            <a href="<?php echo e(route('public.tickets.confirmation', $order)); ?>" 
            ...
            <a href="<?php echo e(route('public.tickets.my-tickets')); ?>" 
...
<?php echo $__env->make('layouts.public', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/administrator/Desktop/Project/Github/warzone-ticketing-system/resources/views/public/tickets/success.blade.php ENDPATH**/ ?>
                            ...
                            <div class="space-y-4">
                                ...
                                <div class="flex items-center py-3 border-b border-wwc-neutral-100">
                                    ...
                                    <div class="flex-1 flex items-center justify-between">
                                        ...
                                        <span class="text-base font-medium text-wwc-neutral-900">RM<?php echo e(number_format($order->total_amount, 2)); ?></span>
                                    </div>
                                </div>
                                    ...
                                    <div class="bg-wwc-neutral-50 rounded-lg p-4">
                                        <div class="flex items-center justify-between mb-3">
                                            ...
                                            <div class="text-right">
                                                <p class="text-lg font-bold text-wwc-neutral-900">RM<?php echo e(number_format($ticket->price_paid, 0)); ?></p>
                                                <span class="inline-flex items-center px-2 py-1 rounded-full text-xs font-semibold
                                                    <?php if($ticket->status === 'sold'): ?> bg-green-100 text-green-800
                                                    <?php elseif($ticket->status === 'scanned'): ?> bg-blue-100 text-blue-800
                                                    <?php elseif($ticket->status === 'pending'): ?> bg-yellow-100 text-yellow-800
                    ...
                    <div class="bg-white rounded-2xl shadow-sm border border-wwc-neutral-200">
                        ...
                        <div class="p-6 space-y-4">
                            <div class="flex items-center justify-between">
                                ...
                                <span class="text-base font-medium text-wwc-neutral-900">RM<?php echo e(number_format($order->subtotal, 2)); ?></span>
                            </div>
                            <div class="flex items-center justify-between">
                                <span class="text-sm font-semibold text-wwc-neutral-600">Service Fee</span>
                                <span class="text-base font-medium text-wwc-neutral-900">RM<?php echo e(number_format($order->service_fee, 2)); ?></span>
                            </div>
                            <div class="flex items-center justify-between">

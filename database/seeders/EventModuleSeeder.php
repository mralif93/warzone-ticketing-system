    ...
    public function run(): void
    {
        ...
        $events = [
            [
                ...
                'end_date' => now()->addDays(31)->setTime(23, 0),
                'status' => 'on_sale',
            ...
            [
                ...
                'total_seats' => 2000,
                'description' => 'The biggest technology conference of the year - 1 day of innovation, networking, and cutting-edge technology presentations.',
            ...
            [
                ...
                'end_date' => '2026-02-14 23:00:00',
                'status' => 'inactive',
                'max_tickets_per_order' => 6,
                'total_seats' => 8000,
                'description' => '1-day music festival featuring international artists and local talents. A celebration of music, culture, and community.',

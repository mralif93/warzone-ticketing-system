                                ...
                                <div class="flex items-center justify-between mb-4">
                                    <div class="flex items-center space-x-4">
                                        ...
                                        <div class="flex-1 min-w-0">
                                            <h3 class="text-lg font-semibold text-wwc-neutral-900">Order #<?php echo e($order->order_number); ?></h3>
                                        ...
                                        <div class="text-right flex-shrink-0">
                                            <div class="text-xl font-bold text-wwc-neutral-900 mb-2">RM<?php echo e(number_format($order->total_amount, 0)); ?></div>
                                        ...
                                        <div class="flex items-center justify-between p-3 bg-white rounded-lg">
                                            <div class="flex items-center space-x-3">
                                                ...
                                                <div>
                                                    ...
                                                    <p class="text-xs text-wwc-neutral-500"><?php echo e($ticket->seat_identifier); ?> • <?php echo e($ticket->seat->price_zone); ?></p>
                                                </div>
                                            </div>
                                ...
                                <div class="border-t border-wwc-neutral-200 pt-4 mt-4">
                                    <div class="flex justify-between items-center">
                                        <div class="text-sm text-wwc-neutral-600">
                                            <p>Subtotal: RM<?php echo e(number_format($order->subtotal, 0)); ?></p>
                                            <p>Service Fee: RM<?php echo e(number_format($order->service_fee, 0)); ?></p>
                                            <p>Tax: RM<?php echo e(number_format($order->tax_amount, 0)); ?></p>
                                        </div>
                                        <div class="text-right">

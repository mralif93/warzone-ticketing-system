                        ...
                        <div class="space-y-4">
                            ...
                            <div class="flex items-center py-3 border-b border-wwc-neutral-100">
                                ...
                                <div class="flex-1 flex items-center justify-between">
                                    ...
                                    <span class="text-base font-medium text-wwc-neutral-900">{{ $ticket->ticket_identifier }}</span>
                                </div>
                            </div>
                            ...
                            <div class="flex items-center py-3 border-b border-wwc-neutral-100">
                                <div class="flex-shrink-0 mr-4">
                                    <div class="h-8 w-8 rounded-lg bg-purple-100 flex items-center justify-center">
                                        <i class='bx bx-map text-sm text-purple-600'></i>
                                    </div>
                                </div>
                                <div class="flex-1 flex items-center justify-between">
                                    <span class="text-sm font-semibold text-wwc-neutral-600">Zone</span>
                                    <span class="text-base font-medium text-wwc-neutral-900">{{ $ticket->zone }}</span>
                                </div>
                            </div>
                            ...
                            <div class="flex items-center py-3">
                                <div class="flex-shrink-0 mr-4">
                                    <div class="h-8 w-8 rounded-lg bg-green-100 flex items-center justify-center">
                                        <i class='bx bx-check-double text-sm text-green-600'></i>
                                    </div>
                                </div>
                                <div class="flex-1 flex items-center justify-between">
                                    <span class="text-sm font-semibold text-wwc-neutral-600">Scanned At</span>
                                    <span class="text-base font-medium text-wwc-neutral-900">{{ $ticket->scanned_at->format('M j, Y g:i A') }}</span>
                                </div>
                            </div>
                            @endif
                        </div>
                    ...
                    <div class="bg-white rounded-2xl shadow-sm border border-wwc-neutral-200">
                        ...
                        <div class="p-6">
                            <div class="space-y-6">
                                ...
                                <!-- Price -->
                                <div class="text-center">
                                    <div class="text-3xl font-bold text-wwc-neutral-900 font-display">RM{{ number_format($ticket->price_paid, 0) }}</div>
                                    <div class="text-sm text-wwc-neutral-600 font-medium">Price Paid</div>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="p-6">
                            <div class="space-y-3">
                                ...
                                @elseif($ticket->status === 'Scanned')
                                    <div class="bg-green-100 text-green-800 px-4 py-2 rounded-lg text-center text-sm font-medium">
                                        <i class='bx bx-check-double text-sm mr-2'></i>
                                        Already Scanned
                                    </div>
                                @endif

    ...
    <div class="px-6 py-6">
        <div class="mx-auto">
            ...
            <div class="bg-white shadow-sm rounded-2xl border border-wwc-neutral-200 mb-6">
                ...
                <div class="p-6">
                    <form method="GET" action="<?php echo e(route('admin.tickets.index')); ?>" class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-5">
                        <div>
                        ...
                        <div>
                            ...
                            <select name="price_zone" id="price_zone" class="block w-full px-3 py-2 border border-wwc-neutral-300 rounded-2xl focus:ring-2 focus:ring-wwc-primary focus:border-wwc-primary text-sm">
                                ...
                                <?php $__currentLoopData = \App\Models\PriceZone::active()->ordered()->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $zone): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($zone->name); ?>" <?php echo e(request('price_zone') == $zone->name ? 'selected' : ''); ?>>
                ...
                <div class="px-6 py-4 border-b border-wwc-neutral-200 bg-wwc-neutral-50">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-wwc-neutral-600 text-sm">Showing <?php echo e($tickets->count()); ?> of <?php echo e($tickets->total()); ?> tickets</p>
                        </div>
                        <div class="flex items-center space-x-3">
                            <div class="text-xs text-wwc-neutral-600">
                                <span class="font-semibold"><?php echo e($tickets->where('status', 'Sold')->count()); ?></span> Sold
                            </div>
                            <div class="text-xs text-wwc-neutral-600">
                                <span class="font-semibold"><?php echo e($tickets->where('status', 'Held')->count()); ?></span> Held
                            </div>
                            <div class="text-xs text-wwc-neutral-600">
                                <span class="font-semibold"><?php echo e($tickets->where('status', 'Used')->count()); ?></span> Used
                            </div>
                            <div class="text-xs text-wwc-neutral-600">
                                <span class="font-semibold"><?php echo e($tickets->where('status', 'Cancelled')->count()); ?></span> Cancelled
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <tr class="hover:bg-wwc-neutral-50 transition-colors duration-200">
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex items-center">
                                            ...
                                            <div class="ml-4">
                                                <div class="text-sm font-semibold text-wwc-neutral-900 font-display">#<?php echo e($ticket->id); ?></div>

<?php $__env->startSection('title', 'Price Zone Details'); ?>
<?php $__env->startSection('page-title', 'Price Zone Details'); ?>
                            ...
                            <div class="space-y-4">
                                ...
                                <div class="flex items-center py-3 border-b border-wwc-neutral-100">
                                    ...
                                    <div class="flex-1 flex items-center justify-between">
                                        ...
                                        <span class="text-base font-medium text-wwc-neutral-900"><?php echo e($priceZone->name); ?></span>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-center py-3 border-b border-wwc-neutral-100">
                                    ...
                                    <div class="flex-1 flex items-center justify-between">
                                        ...
                                        <span class="text-base font-medium text-wwc-neutral-900"><?php echo e($priceZone->code); ?></span>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-center py-3 border-b border-wwc-neutral-100">
                                    ...
                                    <div class="flex-1 flex items-center justify-between">
                                        ...
                                        <span class="text-base font-medium text-wwc-neutral-900"><?php echo e($priceZone->formatted_price); ?></span>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-center py-3 border-b border-wwc-neutral-100">
                                    ...
                                    <div class="flex-1 flex items-center justify-between">
                                        ...
                                        <span class="text-base font-medium text-wwc-neutral-900">
                                            <div class="flex items-center">
                                                <div class="w-4 h-4 rounded-full <?php echo e(str_replace('text-', 'bg-', $priceZone->color)); ?> mr-2"></div>
                                                <?php echo e(ucfirst(str_replace(['text-', '-600'], '', $priceZone->color))); ?>
                                ...
                                <div class="flex items-center py-3 border-b border-wwc-neutral-100">
                                    ...
                                    <div class="flex-1 flex items-center justify-between">
                                        ...
                                        <span class="text-base font-medium text-wwc-neutral-900">
                                            <?php if($priceZone->icon): ?>
                                                <i class='<?php echo e($priceZone->icon); ?> <?php echo e($priceZone->color); ?> text-lg'></i>
                                                <span class="ml-2"><?php echo e($priceZone->icon); ?></span>
                                            <?php else: ?>
                                ...
                                <div class="flex items-center py-3 border-b border-wwc-neutral-100">
                                    ...
                                    <div class="flex-1 flex items-center justify-between">
                                        ...
                                        <span class="text-base font-medium text-wwc-neutral-900"><?php echo e($priceZone->sort_order); ?></span>
                                    </div>
                                </div>
                                ...
                                <?php if($priceZone->description): ?>
                                    <div class="flex items-center py-3">
                                        ...
                                        <div class="flex-1 flex items-center justify-between">
                                            ...
                                            <span class="text-base font-medium text-wwc-neutral-900"><?php echo e($priceZone->description); ?></span>
                                        </div>
                                    </div>
                                <?php endif; ?>
                            </div>
                        ...
                        <div class="p-6">
                            <div class="space-y-4">
                                ...
                                <div class="text-center">
                                    <div class="text-2xl font-bold text-wwc-neutral-900"><?php echo e($priceZone->created_at->format('M d, Y')); ?></div>
                                    <div class="text-sm text-wwc-neutral-500">Created Date</div>
                                </div>
                                <!-- Updated Date -->
                                <div class="text-center">
                                    <div class="text-2xl font-bold text-wwc-neutral-900"><?php echo e($priceZone->updated_at->format('M d, Y')); ?></div>
                                    <div class="text-sm text-wwc-neutral-500">Last Updated</div>
                                </div>
                                <!-- Seats Count -->
                                <div class="text-center">
                                    <div class="text-2xl font-bold text-wwc-neutral-900"><?php echo e($priceZone->seats_count ?? 0); ?></div>
                            ...
                            <div class="space-y-3">
                                ...
                                <a href="<?php echo e(route('admin.price-zones.toggle-status', $priceZone)); ?>" 
                                   class="w-full inline-flex items-center justify-center px-4 py-2 border border-wwc-neutral-300 rounded-lg shadow-sm text-sm font-semibold text-wwc-neutral-700 bg-white hover:bg-wwc-neutral-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-wwc-primary transition-colors duration-200">
                                    <i class='bx bx-<?php echo e($priceZone->is_active ? 'x' : 'check'); ?> text-sm mr-2'></i>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/administrator/Desktop/Project/Github/warzone-ticketing-system/resources/views/admin/price-zones/show.blade.php ENDPATH**/ ?>
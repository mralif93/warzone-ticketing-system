...
unset($__errorArgs, $__bag); ?>">
                                        ...
                                        <option value="on_sale" <?php echo e(old('status', $event->status) == 'on_sale' ? 'selected' : ''); ?>>On Sale</option>
                                        <option value="sold_out" <?php echo e(old('status', $event->status) == 'sold_out' ? 'selected' : ''); ?>>Sold Out</option>

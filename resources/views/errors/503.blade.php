...
<head>
    ...
    <title>Service Unavailable - Warzone Ticketing System</title>
...
<body class="font-sans antialiased bg-gradient-to-br from-red-50 to-rose-100">
    <div class="min-h-screen flex items-center justify-center px-4 py-12">
        <div class="max-w-md w-full text-center">
            <!-- Error Icon -->
            <div class="inline-flex items-center justify-center w-24 h-24 bg-yellow-500 rounded-full mb-6 shadow-lg">
                <i class="bx bx-wrench text-5xl text-white"></i>
            </div>
            
            <!-- Error Title -->
            <h1 class="text-5xl font-bold text-gray-900 mb-4">503</h1>
            ...
            <div class="space-y-3">
                ...
                <button onclick="location.reload()" 
                    ...
                    <i class="bx bx-refresh mr-2"></i> Refresh Page
                </button>
            </div>
        </div>
    </div>

...
<head>
    ...
    <title>@yield('title', 'Admin Dashboard') - {{ config('app.name', 'Warzone Ticketing System') }}</title>
                    ...
                    <div class="flex flex-col items-center">
                        ...
                        <div class="w-full p-4 bg-white bg-opacity-10 backdrop-blur-sm rounded-2xl">
                            ...
                            <div class="text-white text-xs text-center opacity-90">
                                Last Login {{ auth()->user()->updated_at->format('M j, Y') }} at {{ auth()->user()->updated_at->format('g:i A') }}
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <nav class="flex-1 px-6 py-8 space-y-2">
                    ...
                    <a href="{{ route('admin.dashboard') }}" 
                       class="group flex items-center px-4 py-4 text-sm font-semibold rounded-xl transition-all duration-300 {{ request()->routeIs('admin.dashboard') ? 'bg-gradient-to-r from-wwc-primary-light to-red-100 text-wwc-primary shadow-lg border border-red-200' : 'text-wwc-neutral-600 hover:bg-wwc-neutral-50 hover:text-wwc-neutral-900 hover:shadow-md' }}">
                        <div class="flex-shrink-0 mr-4">
                            <div class="h-10 w-10 rounded-xl flex items-center justify-center {{ request()->routeIs('admin.dashboard') ? 'bg-wwc-primary-light' : 'bg-wwc-neutral-100 group-hover:bg-wwc-neutral-200' }} transition-colors duration-300">
                                <i class='bx bx-home text-lg {{ request()->routeIs('admin.dashboard') ? 'text-wwc-primary' : 'text-wwc-neutral-500 group-hover:text-wwc-neutral-700' }}'></i>
                            </div>
                        </div>
                        <div class="flex-1">
                    ...
                    <a href="{{ route('admin.events.index') }}" 
                       class="group flex items-center px-4 py-4 text-sm font-semibold rounded-xl transition-all duration-300 {{ request()->routeIs('admin.events*') ? 'bg-gradient-to-r from-wwc-primary-light to-red-100 text-wwc-primary shadow-lg border border-red-200' : 'text-wwc-neutral-600 hover:bg-wwc-neutral-50 hover:text-wwc-neutral-900 hover:shadow-md' }}">
                        <div class="flex-shrink-0 mr-4">
                            <div class="h-10 w-10 rounded-xl flex items-center justify-center {{ request()->routeIs('admin.events*') ? 'bg-wwc-primary-light' : 'bg-wwc-neutral-100 group-hover:bg-wwc-neutral-200' }} transition-colors duration-300">
                                <i class='bx bx-calendar text-lg {{ request()->routeIs('admin.events*') ? 'text-wwc-primary' : 'text-wwc-neutral-500 group-hover:text-wwc-neutral-700' }}'></i>
                            </div>
                        </div>
                        <div class="flex-1">
                    ...
                    <a href="{{ route('admin.reports') }}" 
                       class="group flex items-center px-4 py-4 text-sm font-semibold rounded-xl transition-all duration-300 {{ request()->routeIs('admin.reports*') ? 'bg-gradient-to-r from-wwc-primary-light to-red-100 text-wwc-primary shadow-lg border border-red-200' : 'text-wwc-neutral-600 hover:bg-wwc-neutral-50 hover:text-wwc-neutral-900 hover:shadow-md' }}">
                        <div class="flex-shrink-0 mr-4">
                            <div class="h-10 w-10 rounded-xl flex items-center justify-center {{ request()->routeIs('admin.reports*') ? 'bg-wwc-primary-light' : 'bg-wwc-neutral-100 group-hover:bg-wwc-neutral-200' }} transition-colors duration-300">
                                <i class='bx bx-bar-chart text-lg {{ request()->routeIs('admin.reports*') ? 'text-wwc-primary' : 'text-wwc-neutral-500 group-hover:text-wwc-neutral-700' }}'></i>
                            </div>
                        </div>
                        <div class="flex-1">
                    ...
                    <a href="{{ route('admin.settings') }}" 
                       class="group flex items-center px-4 py-4 text-sm font-semibold rounded-xl transition-all duration-300 {{ request()->routeIs('admin.settings*') ? 'bg-gradient-to-r from-wwc-primary-light to-red-100 text-wwc-primary shadow-lg border border-red-200' : 'text-wwc-neutral-600 hover:bg-wwc-neutral-50 hover:text-wwc-neutral-900 hover:shadow-md' }}">
                        <div class="flex-shrink-0 mr-4">
                            <div class="h-10 w-10 rounded-xl flex items-center justify-center {{ request()->routeIs('admin.settings*') ? 'bg-wwc-primary-light' : 'bg-wwc-neutral-100 group-hover:bg-wwc-neutral-200' }} transition-colors duration-300">
                                <i class='bx bx-cog text-lg {{ request()->routeIs('admin.settings*') ? 'text-wwc-primary' : 'text-wwc-neutral-500 group-hover:text-wwc-neutral-700' }}'></i>
                            </div>
                        </div>
                        <div class="flex-1">
                    ...
                    <a href="{{ route('gate-staff.scanner') }}" 
                       class="group flex items-center px-4 py-4 text-sm font-semibold rounded-xl transition-all duration-300 {{ request()->routeIs('gate-staff.scanner') ? 'bg-gradient-to-r from-wwc-primary-light to-red-100 text-wwc-primary shadow-lg border border-red-200' : 'text-wwc-neutral-600 hover:bg-wwc-neutral-50 hover:text-wwc-neutral-900 hover:shadow-md' }}">
                        <div class="flex-shrink-0 mr-4">
                            <div class="h-10 w-10 rounded-xl flex items-center justify-center {{ request()->routeIs('gate-staff.scanner') ? 'bg-wwc-primary-light' : 'bg-wwc-neutral-100 group-hover:bg-wwc-neutral-200' }} transition-colors duration-300">
                                <i class='bx bx-qr-scan text-lg {{ request()->routeIs('gate-staff.scanner') ? 'text-wwc-primary' : 'text-wwc-neutral-500 group-hover:text-wwc-neutral-700' }}'></i>
                            </div>
                        </div>
                        <div class="flex-1">
                    ...
                    <a href="{{ route('gate-staff.dashboard') }}" 
                       class="group flex items-center px-4 py-4 text-sm font-semibold rounded-xl transition-all duration-300 {{ request()->routeIs('gate-staff.dashboard') ? 'bg-gradient-to-r from-wwc-primary-light to-red-100 text-wwc-primary shadow-lg border border-red-200' : 'text-wwc-neutral-600 hover:bg-wwc-neutral-50 hover:text-wwc-neutral-900 hover:shadow-md' }}">
                        <div class="flex-shrink-0 mr-4">
                            <div class="h-10 w-10 rounded-xl flex items-center justify-center {{ request()->routeIs('gate-staff.dashboard') ? 'bg-wwc-primary-light' : 'bg-wwc-neutral-100 group-hover:bg-wwc-neutral-200' }} transition-colors duration-300">
                                <i class='bx bx-tachometer text-lg {{ request()->routeIs('gate-staff.dashboard') ? 'text-wwc-primary' : 'text-wwc-neutral-500 group-hover:text-wwc-neutral-700' }}'></i>
                            </div>
                        </div>
                        <div class="flex-1">
                    ...
                    <a href="{{ route('gate-staff.scan-history') }}" 
                       class="group flex items-center px-4 py-4 text-sm font-semibold rounded-xl transition-all duration-300 {{ request()->routeIs('gate-staff.scan-history') ? 'bg-gradient-to-r from-wwc-primary-light to-red-100 text-wwc-primary shadow-lg border border-red-200' : 'text-wwc-neutral-600 hover:bg-wwc-neutral-50 hover:text-wwc-neutral-900 hover:shadow-md' }}">
                        <div class="flex-shrink-0 mr-4">
                            <div class="h-10 w-10 rounded-xl flex items-center justify-center {{ request()->routeIs('gate-staff.scan-history') ? 'bg-wwc-primary-light' : 'bg-wwc-neutral-100 group-hover:bg-wwc-neutral-200' }} transition-colors duration-300">
                                <i class='bx bx-history text-lg {{ request()->routeIs('gate-staff.scan-history') ? 'text-wwc-primary' : 'text-wwc-neutral-500 group-hover:text-wwc-neutral-700' }}'></i>
                            </div>
                        </div>
                        <div class="flex-1">
                ...
                <div class="flex items-center justify-between h-16 px-8 w-full">
                    ...
                    <div class="flex items-center space-x-3">
                        <div class="flex items-center space-x-3">
                            ...
                            <div class="flex flex-col">
                                <span class="text-sm font-semibold text-wwc-neutral-900">{{ auth()->user()->name }}</span>
                                <span class="text-xs text-wwc-neutral-500 capitalize font-medium">{{ auth()->user()->role }}</span>
                            </div>
                        </div>
                        <div class="relative">

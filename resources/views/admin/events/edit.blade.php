                            ...
                            <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                                ...
                                <div>
                                    ...
                                    <select name="status" id="status" required
                                        ...
                                        <option value="on_sale" {{ old('status', $event->status) == 'on_sale' ? 'selected' : '' }}>On Sale</option>
                                        <option value="sold_out" {{ old('status', $event->status) == 'sold_out' ? 'selected' : '' }}>Sold Out</option>

...
<div class="min-h-screen bg-wwc-neutral-50">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-wwc-neutral-200 mb-8">
            ...
            <div class="p-6">
                <form method="GET" action="<?php echo e(route('customer.orders')); ?>" class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
                    <div>
            ...
            <div class="px-6 py-4 border-b border-wwc-neutral-200">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-wwc-neutral-600 text-sm mt-1">Showing <?php echo e($orders->count()); ?> of <?php echo e($orders->total()); ?> orders</p>
                    </div>
                </div>
            </div>
            ...
            <?php if($orders->count() > 0): ?>
                <div class="p-6">
                    <div class="space-y-6">
                        ...
                        <a href="<?php echo e(route('customer.orders.show', $order)); ?>" class="block">
                                    ...
                                    <div class="flex items-center justify-between">
                                        ...
                                        <div class="flex items-center space-x-4">
                                            ...
                                            <div class="flex-1 min-w-0">
                                                <h3 class="text-lg font-semibold text-wwc-neutral-900 group-hover:text-wwc-primary transition-colors duration-200">Order #<?php echo e($order->order_number); ?></h3>
                                                <div class="flex flex-wrap gap-4 mt-2">
                                                    <div class="flex items-center text-sm text-wwc-neutral-600">
                                                        <i class='bx bx-calendar mr-2 text-wwc-neutral-400'></i>
                                                        <?php echo e($order->created_at->format('M j, Y \a\t g:i A')); ?>
                                                    ...
                                                    <div class="flex items-center text-sm text-wwc-neutral-600">
                                                        ...
                                                        <?php echo e($order->tickets->count()); ?> ticket(s)
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="text-right flex-shrink-0">
                                            <div class="text-2xl font-bold text-wwc-neutral-900 mb-2">RM <?php echo e(number_format($order->total_amount, 0)); ?></div>
                                            <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-semibold
                                                <?php if($order->status === 'Completed'): ?> bg-wwc-success text-white
                                                <?php elseif($order->status === 'Pending'): ?> bg-wwc-warning text-white
                                                <?php elseif($order->status === 'Cancelled'): ?> bg-wwc-error text-white
                                                <?php elseif($order->status === 'Refunded'): ?> bg-wwc-info text-white
                                        ...
                                        <div class="space-y-3">
                                            ...
                                            <div class="flex items-center justify-between p-4 bg-wwc-neutral-50 rounded-lg border border-wwc-neutral-200">
                                                ...
                                                <div class="h-10 w-10 rounded-lg bg-wwc-primary flex items-center justify-center">
                                                    ...
                                                    <div>
                                                        <p class="text-sm font-semibold text-wwc-neutral-900"><?php echo e($ticket->event->name); ?></p>
                                                        <p class="text-xs text-wwc-neutral-500 mt-1"><?php echo e($ticket->ticket_identifier); ?></p>
                                                    </div>
                                                </div>
                                                <div class="text-right">
                                                    <p class="text-sm font-semibold text-wwc-neutral-900">RM<?php echo e(number_format($ticket->price_paid, 0)); ?></p>
                                    ...
                                    <div class="border-t border-wwc-neutral-200 pt-4">
                                        <div class="text-sm text-wwc-neutral-600 space-y-2">
                                            <div class="flex justify-between items-center">
                                                <span>Subtotal:</span>
                                                <span class="font-medium">RM<?php echo e(number_format($order->subtotal, 0)); ?></span>
                                            </div>
                                            <div class="flex justify-between items-center">
                                                <span>Service Fee:</span>
                                                <span class="font-medium">RM<?php echo e(number_format($order->service_fee, 0)); ?></span>
                                            </div>
                                            <div class="flex justify-between items-center">
                                                <span>Tax:</span>
                                                <span class="font-medium">RM<?php echo e(number_format($order->tax_amount, 0)); ?></span>
                                            </div>
                                        </div>
                                    </div>
                                </div>

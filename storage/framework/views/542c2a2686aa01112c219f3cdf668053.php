            ...
            <div class="p-6">
                ...
                <div class="space-y-6">
                    ...
                    <div class="flex items-center justify-between py-4">
                        ...
                        <dd class="text-3xl font-bold text-wwc-primary">RM<?php echo e(number_format($order->total_amount, 2)); ?></dd>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="text-center">
                            ...
                            <div class="mt-6 grid grid-cols-3 gap-4 text-xs text-wwc-neutral-500">
                                ...
                                <div class="bg-white rounded-lg p-3">
                                    ...
                                    <p class="font-mono">RM<?php echo e(number_format($order->total_amount, 2)); ?></p>
                                </div>
                                <div class="bg-white rounded-lg p-3">
                        ...
                        <div class="bg-wwc-neutral-50 rounded-xl p-6 border border-wwc-neutral-200">
                            <div class="flex items-center justify-between">
                                ...
                                <div class="text-right">
                                    <div class="text-2xl font-bold text-wwc-primary">RM<?php echo e(number_format($ticket->price_paid, 2)); ?></div>

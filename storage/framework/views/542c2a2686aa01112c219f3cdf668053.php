<?php $__env->startSection('title', 'Purchase Confirmation'); ?>
<?php $__env->startSection('description', 'Your ticket purchase has been confirmed. View your order details and QR codes.'); ?>
            ...
            <div class="p-6">
                ...
                <div class="space-y-6">
                    ...
                    <div class="flex items-center justify-between py-4 border-b border-wwc-neutral-100">
                        ...
                        <dd class="text-lg font-semibold text-wwc-neutral-900"><?php echo e($order->order_number); ?></dd>
                    </div>
                    ...
                    <div class="flex items-center justify-between py-4 border-b border-wwc-neutral-100">
                        ...
                        <dd class="text-lg font-semibold text-wwc-neutral-900"><?php echo e($order->created_at->format('M j, Y \a\t g:i A')); ?></dd>
                    </div>
                    ...
                    <div class="flex items-center justify-between py-4 border-b border-wwc-neutral-100">
                        ...
                        <dd class="text-lg font-semibold text-wwc-neutral-900"><?php echo e($order->tickets->first()->event->name); ?></dd>
                    </div>
                    ...
                    <div class="flex items-center justify-between py-4">
                        ...
                        <dd class="text-3xl font-bold text-wwc-primary">RM<?php echo e(number_format($order->total_amount, 0)); ?></dd>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="inline-block p-8 bg-wwc-neutral-50 rounded-xl border-2 border-dashed border-wwc-neutral-300">
                        <div class="text-center">
                            ...
                            <div class="mx-auto mb-6">
                                <img src="<?php echo e(\App\Services\QRCodeService::generateQRCodeImage($order)); ?>" 
                                     alt="Order QR Code" 
                            ...
                            <div class="text-center">
                                ...
                                <p class="text-xl font-bold text-wwc-neutral-900 font-mono"><?php echo e($order->qrcode); ?></p>
                            </div>
                            ...
                            <div class="mt-6 grid grid-cols-3 gap-4 text-xs text-wwc-neutral-500">
                                <div class="bg-white rounded-lg p-3">
                                    ...
                                    <p class="font-mono"><?php echo e($order->order_number); ?></p>
                                </div>
                                <div class="bg-white rounded-lg p-3">
                                    <p class="font-semibold text-wwc-neutral-700">Amount</p>
                                    <p class="font-mono">RM<?php echo e(number_format($order->total_amount, 0)); ?></p>
                                </div>
                                <div class="bg-white rounded-lg p-3">
                                    <p class="font-semibold text-wwc-neutral-700">Tickets</p>
                                    <p class="font-mono"><?php echo e($order->getTicketsCount()); ?></p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="bg-wwc-neutral-50 rounded-xl p-6 border border-wwc-neutral-200">
                            <div class="flex items-center justify-between">
                                <div class="flex items-center space-x-4">
                                    ...
                                    <div class="flex-1">
                                        <h4 class="text-lg font-semibold text-wwc-neutral-900"><?php echo e($ticket->ticket_identifier); ?></h4>
                                        <div class="mt-1 space-y-1">
                                            <p class="text-sm text-wwc-neutral-600">
                                                <span class="font-medium">Zone:</span> <?php echo e($ticket->zone); ?>

                                            </p>
                                            <p class="text-sm text-wwc-neutral-600">
                                                <span class="font-medium">QR Code:</span> 
                                                <span class="font-mono"><?php echo e($ticket->qrcode); ?></span>
                                            </p>
                                            <p class="text-sm text-wwc-neutral-600">
                                                <span class="font-medium">Ticket #:</span> <?php echo e($ticket->id); ?>
                                ...
                                <div class="text-right">
                                    <div class="text-2xl font-bold text-wwc-primary">RM<?php echo e(number_format($ticket->price_paid, 0)); ?></div>
...
<?php echo $__env->make('layouts.customer', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/administrator/Desktop/Project/Github/warzone-ticketing-system/resources/views/public/tickets/confirmation.blade.php ENDPATH**/ ?>
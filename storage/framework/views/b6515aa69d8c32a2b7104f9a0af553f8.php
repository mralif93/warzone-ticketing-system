<?php $__env->startSection('title', 'Ticket Type Details - ' . $ticket->name); ?>
<?php $__env->startSection('page-title', 'Ticket Type Details'); ?>
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="flex items-center py-3 border-b border-wwc-neutral-100">
                                ...
                                <div class="flex-1 flex items-center justify-between">
                                    ...
                                    <span class="text-base font-medium text-wwc-neutral-900"><?php echo e($ticket->name); ?></span>
                                </div>
                            </div>
                            ...
                            <div class="flex items-center py-3 border-b border-wwc-neutral-100">
                                ...
                                <div class="flex-1 flex items-center justify-between">
                                    ...
                                    <span class="text-base font-medium text-wwc-neutral-900"><?php echo e($ticket->event->name); ?></span>
                                </div>
                            </div>
                            ...
                            <div class="flex items-center py-3 border-b border-wwc-neutral-100">
                                ...
                                <div class="flex-1 flex items-center justify-between">
                                    ...
                                    <span class="text-base font-medium text-wwc-neutral-900">RM<?php echo e(number_format($ticket->price, 0)); ?></span>
                                </div>
                            </div>
                            ...
                            <div class="flex items-center py-3 border-b border-wwc-neutral-100">
                                ...
                                <div class="flex-1 flex items-center justify-between">
                                    ...
                                    <span class="text-base font-medium text-wwc-neutral-900"><?php echo e($ticket->total_seats); ?></span>
                                </div>
                            </div>
                            ...
                            <div class="flex items-center py-3 border-b border-wwc-neutral-100">
                                ...
                                <div class="flex-1 flex items-center justify-between">
                                    ...
                                    <span class="text-base font-medium <?php echo e($ticket->available_seats > 0 ? 'text-green-600' : 'text-red-600'); ?>"><?php echo e($ticket->available_seats); ?></span>
                                </div>
                            </div>
                            ...
                            <div class="flex items-center py-3 border-b border-wwc-neutral-100">
                                ...
                                <div class="flex-1 flex items-center justify-between">
                                    ...
                                    <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium
                                        <?php if($ticket->status === 'active'): ?> bg-green-100 text-green-800
                                        <?php elseif($ticket->status === 'sold_out'): ?> bg-red-100 text-red-800
                                        <?php elseif($ticket->status === 'inactive'): ?> bg-gray-100 text-gray-800
                            ...
                            <div class="flex items-center py-3 border-b border-wwc-neutral-100">
                                ...
                                <div class="flex-1 flex items-center justify-between">
                                    ...
                                    <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium
                                        <?php echo e($ticket->is_combo ? 'bg-orange-100 text-orange-800' : 'bg-gray-100 text-gray-800'); ?>">
                                        <?php echo e($ticket->is_combo ? 'Yes' : 'No'); ?>
                            ...
                            <div class="flex items-center py-3 border-b border-wwc-neutral-100">
                                ...
                                <div class="flex-1 flex items-center justify-between">
                                    ...
                                    <span class="text-base font-medium text-wwc-neutral-900"><?php echo e($ticket->scanned_seats); ?></span>
                                </div>
                            </div>
                            ...
                            <div class="py-3">
                                <div class="flex items-start">
                                    ...
                                    <div class="flex-1">
                                        ...
                                        <p class="text-sm text-wwc-neutral-700"><?php echo e($ticket->description); ?></p>
                                    </div>
                                </div>
                            </div>
                            <?php endif; ?>
                        ...
                        <div class="p-6">
                            <div class="space-y-6">
                                ...
                                <div class="text-center">
                                    <div class="text-3xl font-bold text-green-600 font-display"><?php echo e($ticket->sold_seats); ?></div>
                                    <div class="text-sm text-wwc-neutral-600 font-medium">Sold Seats</div>
                                </div>

                                <!-- Available Seats -->
                                <div class="text-center">
                                    <div class="text-3xl font-bold <?php echo e($ticket->available_seats > 0 ? 'text-blue-600' : 'text-red-600'); ?> font-display"><?php echo e($ticket->available_seats); ?></div>
                                    <div class="text-sm text-wwc-neutral-600 font-medium">Available Seats</div>
                                </div>

                                <!-- Scanned Seats -->
                                <div class="text-center">
                                    <div class="text-3xl font-bold text-indigo-600 font-display"><?php echo e($ticket->scanned_seats); ?></div>
                                    <div class="text-sm text-wwc-neutral-600 font-medium">Scanned Seats</div>
                                </div>

                                <!-- Occupancy Rate -->
                                <div class="text-center">
                                    <div class="text-3xl font-bold text-purple-600 font-display"><?php echo e($ticket->getOccupancyPercentage()); ?>%</div>
                                ...
                                <div class="w-full bg-gray-200 rounded-full h-2">
                                    <div class="bg-gradient-to-r from-green-500 to-blue-500 h-2 rounded-full transition-all duration-500" 
                                         style="width: <?php echo e($ticket->getOccupancyPercentage()); ?>%"></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-2xl shadow-sm border border-wwc-neutral-200">
                        ...
                        <div class="p-6">
                            <div class="space-y-3">
                                ...
                                <?php if($ticket->sold_seats == 0): ?>
                                    <button onclick="confirmDelete('<?php echo e($ticket->id); ?>', '<?php echo e($ticket->name); ?>')" 
                        ...
                        <div class="p-6">
                            <div class="space-y-4">
                                ...
                                <div class="flex items-center justify-between py-2">
                                    ...
                                    <span class="text-sm text-wwc-neutral-900"><?php echo e($ticket->created_at->format('M j, Y g:i A')); ?></span>
                                </div>
                                
                                <!-- Last Updated -->
                                <div class="flex items-center justify-between py-2">
                                    <span class="text-sm font-semibold text-wwc-neutral-600">Last Updated</span>
                                    <span class="text-sm text-wwc-neutral-900"><?php echo e($ticket->updated_at->format('M j, Y g:i A')); ?></span>
                                </div>
                                
                                <!-- Event Date -->
                                <div class="flex items-center justify-between py-2">
                                    <span class="text-sm font-semibold text-wwc-neutral-600">Event Date</span>
                                    <span class="text-sm text-wwc-neutral-900"><?php echo e($ticket->event->date_time->format('M j, Y g:i A')); ?></span>
                                </div>
                                ...
                                <div class="flex items-center justify-between py-2">
                                    ...
                                    <span class="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium
                                        <?php if($ticket->event->status === 'On Sale'): ?> bg-green-100 text-green-800
                                        <?php elseif($ticket->event->status === 'Sold Out'): ?> bg-red-100 text-red-800
                                        <?php elseif($ticket->event->status === 'Cancelled'): ?> bg-gray-100 text-gray-800
                                        <?php else: ?> bg-yellow-100 text-yellow-800 <?php endif; ?>">
                                        <?php echo e($ticket->event->status); ?>

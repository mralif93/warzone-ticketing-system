            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        ...
                        <p class="text-gray-500 text-sm">Ticket #{{ $ticket->id }}</p>
                    </div>
                </div>
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
                    <div class="px-6 py-4 border-b border-wwc-neutral-200">
                        <div class="flex items-center justify-between">
                            <div>
                                <h2 class="text-lg font-semibold text-gray-900">{{ $ticket->event->name }}</h2>
                                <p class="text-gray-500 text-sm mt-1">Event Information</p>
                            </div>
                            <div class="text-right">
                                <div class="text-xl font-semibold text-gray-900">RM{{ number_format($ticket->price_paid, 0) }}</div>
                    ...
                    <div class="p-6">
                        <div class="space-y-4">
                            <div class="flex items-center justify-between">
                                ...
                                <p class="text-gray-900 font-medium">{{ $ticket->event->getFormattedDateRange() }}</p>
                            </div>
                            <div class="flex items-center justify-between">
                                <div class="flex items-center space-x-3">
                                ...
                                <p class="text-gray-900 font-medium">{{ $ticket->event->venue ?? 'Venue TBA' }}</p>
                            </div>
                            <div class="flex items-center justify-between">
                                <div class="flex items-center space-x-3">
                    ...
                    <div class="p-6">
                        <div class="space-y-4">
                            <div class="flex items-center justify-between">
                                ...
                                <p class="text-gray-900 font-medium">{{ $ticket->ticket_identifier ?? 'TKT-' . $ticket->id }}</p>
                            </div>
                            <div class="flex items-center justify-between">
                                <div class="flex items-center space-x-3">
                                ...
                                <p class="text-gray-900 font-medium">{{ $ticket->zone ?? 'General' }}</p>
                            </div>
                            <div class="flex items-center justify-between">
                                <div class="flex items-center space-x-3">
                                ...
                                <p class="text-gray-900 font-medium">#{{ $ticket->id }}</p>
                            </div>
                            <div class="flex items-center justify-between">
                                <div class="flex items-center space-x-3">
                                ...
                                <p class="text-gray-900 font-medium">{{ $ticket->order->order_number }}</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="p-6">
                        <div class="text-center">
                            ...
                            <div class="w-48 h-48 bg-white border-2 border-gray-200 rounded-lg flex items-center justify-center mb-4 mx-auto">
                                <img src="{{ \App\Services\QRCodeService::generateQRCodeImage($ticket->order) }}" 
                                     alt="Ticket QR Code" 
                            ...
                            <div class="bg-gray-50 rounded-lg p-3 border border-gray-200">
                                <p class="text-xs text-gray-600 break-all">{{ $ticket->qrcode }}</p>
                            </div>

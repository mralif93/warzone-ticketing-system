<?php $__env->startSection('title', 'Edit Price Zone'); ?>
<?php $__env->startSection('page-title', 'Edit Price Zone'); ?>
    ...
    <div class="px-6 py-6">
        <div class="mx-auto">
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-wwc-neutral-200">
                ...
                <div class="p-6">
                    <form action="<?php echo e(route('admin.price-zones.update', $priceZone)); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                            ...
                            <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="name" id="name" required
                                           value="<?php echo e(old('name', $priceZone->name)); ?>"
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div>
                                    ...
                                    <input type="text" name="code" id="code" required
                                           value="<?php echo e(old('code', $priceZone->code)); ?>"
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div>
                                    ...
                                    <input type="number" name="base_price" id="base_price" required step="0.01" min="0"
                                           value="<?php echo e(old('base_price', $priceZone->base_price)); ?>"
...
unset($__errorArgs, $__bag); ?>">
                                        ...
                                        <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($category); ?>" <?php echo e(old('category', $priceZone->category) == $category ? 'selected' : ''); ?>><?php echo e($category); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
...
unset($__errorArgs, $__bag); ?>">
                                        ...
                                        <option value="text-blue-600" <?php echo e(old('color', $priceZone->color) == 'text-blue-600' ? 'selected' : ''); ?>>Blue</option>
                                        <option value="text-green-600" <?php echo e(old('color', $priceZone->color) == 'text-green-600' ? 'selected' : ''); ?>>Green</option>
                                        <option value="text-yellow-600" <?php echo e(old('color', $priceZone->color) == 'text-yellow-600' ? 'selected' : ''); ?>>Yellow</option>
                                        <option value="text-red-600" <?php echo e(old('color', $priceZone->color) == 'text-red-600' ? 'selected' : ''); ?>>Red</option>
                                        <option value="text-purple-600" <?php echo e(old('color', $priceZone->color) == 'text-purple-600' ? 'selected' : ''); ?>>Purple</option>
                                        <option value="text-indigo-600" <?php echo e(old('color', $priceZone->color) == 'text-indigo-600' ? 'selected' : ''); ?>>Indigo</option>
                                        <option value="text-pink-600" <?php echo e(old('color', $priceZone->color) == 'text-pink-600' ? 'selected' : ''); ?>>Pink</option>
                                        <option value="text-orange-600" <?php echo e(old('color', $priceZone->color) == 'text-orange-600' ? 'selected' : ''); ?>>Orange</option>
                                    </select>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div>
                                    ...
                                    <input type="text" name="icon" id="icon"
                                           value="<?php echo e(old('icon', $priceZone->icon)); ?>"
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div>
                                    ...
                                    <input type="number" name="sort_order" id="sort_order" min="0"
                                           value="<?php echo e(old('sort_order', $priceZone->sort_order)); ?>"
...
unset($__errorArgs, $__bag); ?>"
                                              placeholder="Enter price zone description"><?php echo e(old('description', $priceZone->description)); ?></textarea>
                                ...
                                <div class="sm:col-span-2">
                                    <label class="flex items-center">
                                        <input type="checkbox" name="is_active" value="1" 
                                               <?php echo e(old('is_active', $priceZone->is_active) ? 'checked' : ''); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/administrator/Desktop/Project/Github/warzone-ticketing-system/resources/views/admin/price-zones/edit.blade.php ENDPATH**/ ?>
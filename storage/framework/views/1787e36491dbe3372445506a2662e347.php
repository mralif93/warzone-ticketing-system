            ...
            <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4 mb-6">
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-wwc-neutral-200 p-4">
                    <div class="flex items-center justify-between">
                        <div>
                            <div class="text-2xl font-bold text-wwc-neutral-900 mb-1"><?php echo e($ticketTypes->count()); ?></div>
                            ...
                            <div class="flex items-center">
                                <div class="flex items-center text-xs text-wwc-success font-semibold">
                                    ...
                                    <?php echo e($ticketTypes->groupBy('event_id')->count()); ?> Events
                                </div>
                            </div>
                        </div>
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-wwc-neutral-200 p-4">
                    <div class="flex items-center justify-between">
                        <div>
                            <div class="text-2xl font-bold text-wwc-neutral-900 mb-1"><?php echo e(number_format($totalSeats)); ?></div>
                            <div class="text-xs text-wwc-neutral-600 mb-2 font-medium">Total Seats</div>
                            <div class="flex items-center">
                                <div class="flex items-center text-xs text-wwc-success font-semibold">
                                    <i class='bx bx-check text-xs mr-1'></i>
                                    <?php echo e(number_format($soldSeats)); ?> Sold
                                </div>
                            </div>
                        </div>
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-wwc-neutral-200 p-4">
                    <div class="flex items-center justify-between">
                        <div>
                            <div class="text-2xl font-bold text-wwc-neutral-900 mb-1"><?php echo e(number_format($availableSeats)); ?></div>
                            ...
                            <div class="flex items-center">
                                <div class="flex items-center text-xs text-wwc-warning font-semibold">
                                    ...
                                    <?php echo e($ticketTypes->sum('scanned_seats')); ?> Scanned
                                </div>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="flex items-center">
                                <div class="flex items-center text-xs text-wwc-success font-semibold">
                                    ...
                                    RM<?php echo e(number_format($averagePrice, 0)); ?> Avg
                                </div>
                            </div>
                        </div>
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-wwc-neutral-200">
                        ...
                        <div class="flex items-center space-x-4">
                            <div class="flex items-center space-x-4 text-xs text-wwc-neutral-500">
                                ...
                                <span class="flex items-center">
                                    ...
                                    <?php echo e(number_format($availableSeats)); ?> Available
                                </span>
                                <span class="flex items-center">
                                ...
                                <span class="flex items-center">
                                    ...
                                    <?php echo e($soldOutTicketTypes); ?> Sold Out
                                </span>
                                <?php if($comboTicketTypes > 0): ?>
                                <span class="flex items-center">
                                    <div class="w-2 h-2 bg-wwc-accent rounded-full mr-2"></div>
                                    <?php echo e($comboTicketTypes); ?> Combo
                                </span>
                                <?php endif; ?>
                            </div>
                ...
                <?php if($ticketTypes->count() > 0): ?>
                                    ...
                                    <tr class="hover:bg-wwc-neutral-50 transition-colors duration-150">
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="flex items-center">
                                                ...
                                                <div class="ml-4">
                                                    <div class="text-sm font-semibold text-wwc-neutral-900"><?php echo e($ticketType->event->name); ?></div>
                                                    <div class="text-xs text-wwc-neutral-500"><?php echo e($ticketType->event->date_time->format('M j, Y')); ?></div>
                                                </div>
                                            </div>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="flex items-center">
                                                <div class="text-sm font-semibold text-wwc-neutral-900"><?php echo e($ticketType->name); ?></div>
                                            ...
                                            <div class="text-xs text-wwc-neutral-500"><?php echo e($ticketType->sold_seats); ?> sold, <?php echo e($ticketType->scanned_seats); ?> scanned</div>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="text-sm font-semibold text-wwc-neutral-900">RM<?php echo e(number_format($ticketType->price, 0)); ?></div>
                                            <div class="text-xs text-wwc-neutral-500">Per seat</div>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap text-center">
                                            <div class="text-lg font-bold text-wwc-neutral-900"><?php echo e($ticketType->total_seats); ?></div>
                                            <div class="text-xs text-wwc-neutral-500">Total</div>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap text-center">
                                            <div class="text-lg font-bold <?php echo e($ticketType->available_seats > 0 ? 'text-green-600' : 'text-red-600'); ?>"><?php echo e($ticketType->available_seats); ?></div>
                                            <div class="text-xs text-wwc-neutral-500"><?php echo e($ticketType->available_seats > 0 ? 'Available' : 'Sold Out'); ?></div>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap text-center">
                                            <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-semibold
                                                <?php if($ticketType->status === 'active'): ?> bg-green-100 text-green-800
                                                <?php elseif($ticketType->status === 'sold_out'): ?> bg-red-100 text-red-800
                                                <?php elseif($ticketType->status === 'inactive'): ?> bg-gray-100 text-gray-800
                                                <?php else: ?> bg-gray-100 text-gray-800
                                                <?php endif; ?>">
                                                <?php if($ticketType->status === 'active'): ?>
                                                    <i class='bx bx-check-circle text-xs mr-1'></i>
                                                <?php elseif($ticketType->status === 'sold_out'): ?>
                                                    <i class='bx bx-x-circle text-xs mr-1'></i>
                                                <?php elseif($ticketType->status === 'inactive'): ?>
                                                    <i class='bx bx-pause-circle text-xs mr-1'></i>
                                                <?php else: ?>
                                                    <i class='bx bx-question-mark text-xs mr-1'></i>
                                                <?php endif; ?>
                                                <?php echo e(ucfirst(str_replace('_', ' ', $ticketType->status))); ?>

                                            </span>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap text-center">
                                            <div class="text-sm font-semibold text-wwc-neutral-900"><?php echo e($ticketType->getOccupancyPercentage()); ?>%</div>
                                            <div class="w-full bg-gray-200 rounded-full h-2 mt-1">
                                                <div class="bg-blue-600 h-2 rounded-full" style="width: <?php echo e($ticketType->getOccupancyPercentage()); ?>%"></div>
                                            </div>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap text-center">
                                            <?php if($ticketType->seating_image): ?>
                                                <div class="flex justify-center">
                                                    <img src="<?php echo e(asset('storage/' . $ticketType->seating_image)); ?>" 
                                                         alt="Seating layout" 
                                                         ...
                                                         onclick="openImageModal('<?php echo e(asset('storage/' . $ticketType->seating_image)); ?>', '<?php echo e($ticketType->name); ?> Seating Layout')"
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                            <div class="flex items-center justify-end space-x-1">
                                                <a href="<?php echo e(route('admin.tickets.show', $ticketType)); ?>" 
                                                ...
                                                <a href="<?php echo e(route('admin.tickets.edit', $ticketType)); ?>" 
                                                ...
                                                <?php if($ticketType->sold_seats == 0): ?>
                                                    <button onclick="confirmDelete('<?php echo e($ticketType->id); ?>', '<?php echo e($ticketType->name); ?>')" 
                    ...
                    <div class="px-6 py-4 border-t border-wwc-neutral-100">
                        <?php echo e($ticketTypes->appends(request()->query())->links()); ?>

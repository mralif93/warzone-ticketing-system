                        ...
                        <div class="space-y-3">
                            ...
                            <div class="flex items-center justify-center space-x-4">
                                ...
                                <input type="number" 
                                       ...
                                       required
                                            class="w-16 text-center px-2 py-2 border-2 border-gray-200 rounded-lg focus:ring-2 focus:ring-wwc-primary focus:border-wwc-primary <?php $__errorArgs = ['quantity'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?> text-sm font-bold bg-gray-50 transition-all duration-200">
                                </div>
                    ...
                    <div class="p-8 space-y-6">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <input type="text" 
                                    ...
                                    required
                                            class="w-full px-3 py-2 border-2 border-gray-200 rounded-lg focus:ring-2 focus:ring-wwc-primary focus:border-wwc-primary <?php $__errorArgs = ['customer_name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <input type="email" 
                                    ...
                                    required
                                            class="w-full px-3 py-2 border-2 border-gray-200 rounded-lg focus:ring-2 focus:ring-wwc-primary focus:border-wwc-primary <?php $__errorArgs = ['customer_email'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
                        ...
                        <div class="space-y-2">
                            ...
                            <input type="tel" 
                                    ...
                                    value="<?php echo e(old('customer_phone', auth()->user()->phone ?? '')); ?>"
                                        class="w-full px-3 py-2 border-2 border-gray-200 rounded-lg focus:ring-2 focus:ring-wwc-primary focus:border-wwc-primary <?php $__errorArgs = ['customer_phone'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div class="relative group h-full">
                                <input type="radio" 
                                        ...
                                        class="sr-only peer"
                                        <?php echo e(old('payment_method', 'Debit / Credit Card') == 'Debit / Credit Card' ? 'checked' : ''); ?>>
                            ...
                            <div class="relative group h-full">
                                <input type="radio" 
                                        ...
                                        class="sr-only peer"
                                        <?php echo e(old('payment_method') == 'Online Banking' ? 'checked' : ''); ?>>
                            ...
                            <div class="relative group h-full">
                                <input type="radio" 
                                        ...
                                        class="sr-only peer"
                                        <?php echo e(old('payment_method') == 'QR Code / E-Wallet' ? 'checked' : ''); ?>>
                            ...
                            <div class="relative group h-full">
                                <input type="radio" 
                                        ...
                                        value="Bank Transfer" 
                                        class="sr-only peer"
                                        <?php echo e(old('payment_method') == 'Bank Transfer' ? 'checked' : ''); ?>>
...
const eventData = {
    ...
    ticketPrices: {
        <?php $__currentLoopData = $event->tickets->where('available_seats', '>', 0); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ticket): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            '<?php echo e($ticket->id); ?>': <?php echo e($ticket->price); ?>,
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    }
};

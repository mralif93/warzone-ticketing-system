...
<head>
    ...
    <title>@yield('title', 'Customer Dashboard') - Warzone World Championship</title>
    <meta name="description" content="@yield('description', 'Manage your tickets, orders, and profile in your Warzone World Championship customer portal.')">
                ...
                <div class="flex justify-between h-16">
                    ...
                    <div class="hidden md:flex items-center space-x-8">
                        ...
                        <a href="{{ route('customer.support') }}" 
                           class="text-wwc-neutral-600 hover:text-wwc-primary px-3 py-2 text-sm font-medium transition-colors duration-200 {{ request()->routeIs('customer.support*') ? 'text-wwc-primary' : '' }}">
                            Support
                        </a>
                    </div>
                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <div class="relative" x-data="{ open: false }">
                            <button @click="open = !open" class="flex items-center text-sm focus:outline-none">
                                ...
                                <span class="ml-2 text-wwc-neutral-700 font-medium">{{ auth()->user()->name }}</span>

                            ...
                            <div class="space-y-4">
                                ...
                                <div class="flex items-center py-3 border-b border-wwc-neutral-100">
                                    ...
                                    <div class="flex-1 flex items-center justify-between">
                                        ...
                                        <span class="text-base font-medium text-wwc-neutral-900"><?php echo e($user->name); ?></span>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-center py-3 border-b border-wwc-neutral-100">
                                    ...
                                    <div class="flex-1 flex items-center justify-between">
                                        ...
                                        <span class="text-base font-medium text-wwc-neutral-900"><?php echo e($user->email); ?></span>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-center py-3 border-b border-wwc-neutral-100">
                                    ...
                                    <div class="flex-1 flex items-center justify-between">
                                        ...
                                        <span class="text-base font-medium text-wwc-neutral-900"><?php echo e(ucwords(str_replace('_', ' ', $user->role))); ?></span>
                                    </div>
                            </div>
                            ...
                            <!-- Status -->
                                <div class="flex items-center py-3 border-b border-wwc-neutral-100">
                                    ...
                                    <div class="flex-1 flex items-center justify-between">
                                        ...
                                        <span class="text-base font-medium text-wwc-neutral-900"><?php echo e($user->is_active ? 'Active' : 'Inactive'); ?></span>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-center py-3 border-b border-wwc-neutral-100">
                                    ...
                                    <div class="flex-1 flex items-center justify-between">
                                        ...
                                        <span class="text-base font-medium text-wwc-neutral-900"><?php echo e($user->phone_number); ?></span>
                                    </div>
                                </div>
                                <?php endif; ?>
                                ...
                                <div class="flex items-center py-3">
                                    ...
                                    <div class="flex-1 flex items-center justify-between">
                                        ...
                                        <span class="text-base font-medium text-wwc-neutral-900 leading-relaxed text-right max-w-md">
                                            ...
                                            <?php if($user->city): ?>
                                                <br><?php echo e($user->city); ?>, <?php echo e($user->state); ?> <?php echo e($user->postcode); ?>
                        ...
                        <div class="p-6">
                            <div class="space-y-6">
                                ...
                                <div class="text-center">
                                    <div class="text-3xl font-bold text-wwc-neutral-900 font-display"><?php echo e($user->orders_count ?? 0); ?></div>
                                    <div class="text-sm text-wwc-neutral-600 font-medium">Total Orders</div>
            </div>

                                <!-- Tickets Count -->
                                <div class="text-center">
                                    <div class="text-3xl font-bold text-wwc-neutral-900 font-display"><?php echo e($user->customer_tickets_count ?? 0); ?></div>
                                    <div class="text-sm text-wwc-neutral-600 font-medium">Tickets Purchased</div>
                </div>

                                <!-- Member Since -->
                            <div class="text-center">
                                    <div class="text-3xl font-bold text-wwc-neutral-900 font-display"><?php echo e($user->created_at->format('M Y')); ?></div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/administrator/Desktop/Project/Github/warzone-ticketing-system/resources/views/admin/users/show.blade.php ENDPATH**/ ?>
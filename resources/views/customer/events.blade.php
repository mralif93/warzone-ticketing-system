...
@section('description', 'Discover amazing events and get your tickets in your Warzone World Championship customer portal.')
...
<div class="min-h-screen bg-wwc-neutral-50">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-wwc-neutral-200 mb-8">
            ...
            <div class="p-6">
                <form method="GET" action="{{ route('customer.events') }}" class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
                    <div>
            ...
            <div class="px-6 py-4 border-b border-wwc-neutral-200">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-wwc-neutral-600 text-sm mt-1">Showing {{ $events->count() }} of {{ $events->total() }} events</p>
                    </div>
                </div>
            </div>
                        ...
                        <div class="bg-wwc-neutral-50 border border-wwc-neutral-200 rounded-lg hover:bg-wwc-neutral-100 transition-colors duration-200 overflow-hidden">
                            ...
                            <div class="h-48 bg-gradient-to-br from-wwc-primary-light to-wwc-accent-light flex items-center justify-center">
                                <div class="text-center">
                                    ...
                                    <p class="text-sm font-semibold text-wwc-primary">{{ $event->name }}</p>
                                </div>
                            </div>
                            ...
                            <div class="p-6">
                                <div class="mb-4">
                                    ...
                                    <p class="text-sm text-wwc-neutral-600 mb-3">{{ Str::limit($event->description, 100) }}</p>

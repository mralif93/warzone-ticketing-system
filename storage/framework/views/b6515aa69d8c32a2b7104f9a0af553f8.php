                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-white rounded-2xl shadow-sm border border-wwc-neutral-200">
                        ...
                        <div class="p-6 space-y-4">
                            <div class="flex items-center justify-between">
                                ...
                                <span class="text-base font-medium text-wwc-neutral-900"><?php echo e(number_format($ticket->sold_seats)); ?></span>
                            </div>
                            <div class="flex items-center justify-between">
                                <div class="flex items-center space-x-3">
                                    <div class="h-8 w-8 rounded-lg bg-blue-100 flex items-center justify-center">
                                ...
                                <span class="text-base font-medium text-wwc-neutral-900"><?php echo e(number_format($ticket->available_seats)); ?></span>
                            </div>
                            <div class="flex items-center justify-between">
                                <div class="flex items-center space-x-3">
                                    <div class="h-8 w-8 rounded-lg bg-purple-100 flex items-center justify-center">
                                ...
                                <span class="text-base font-medium text-wwc-neutral-900"><?php echo e(number_format($ticket->total_seats)); ?></span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-2xl shadow-sm border border-wwc-neutral-200">
                        ...
                        <div class="p-6">
                            <div class="text-center">
                                ...
                                <p class="text-2xl font-bold text-wwc-neutral-900">RM<?php echo e(number_format($ticket->sold_seats * $ticket->price, 0)); ?></p>
                    ...
                    <div class="bg-white rounded-2xl shadow-sm border border-wwc-neutral-200">
                        ...
                        <div class="p-6 space-y-3">
                            ...
                            <a href="<?php echo e(route('admin.events.show', $ticket->event)); ?>" 

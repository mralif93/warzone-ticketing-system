<?php $__env->startSection('title', 'Create Seat'); ?>
<?php $__env->startSection('page-title', 'Create Seat'); ?>
...
unset($__errorArgs, $__bag); ?>">
                                        ...
                                        <option value="VIP" <?php echo e(old('price_zone') == 'VIP' ? 'selected' : ''); ?>>VIP</option>
                                        <option value="Premium" <?php echo e(old('price_zone') == 'Premium' ? 'selected' : ''); ?>>Premium</option>
                                        <option value="Standard" <?php echo e(old('price_zone') == 'Standard' ? 'selected' : ''); ?>>Standard</option>
                                        <option value="Economy" <?php echo e(old('price_zone') == 'Economy' ? 'selected' : ''); ?>>Economy</option>
                                    </select>
...
unset($__errorArgs, $__bag); ?>">
                                        ...
                                        <option value="Standard" <?php echo e(old('seat_type') == 'Standard' ? 'selected' : ''); ?>>Standard</option>
                                        <option value="Premium" <?php echo e(old('seat_type') == 'Premium' ? 'selected' : ''); ?>>Premium</option>
                                        <option value="VIP" <?php echo e(old('seat_type') == 'VIP' ? 'selected' : ''); ?>>VIP</option>
                                    </select>
                                ...
                                <div class="sm:col-span-2">
                                    <label class="flex items-center">
                                        <input type="checkbox" name="is_accessible" value="1" 
                                               <?php echo e(old('is_accessible') ? 'checked' : ''); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/administrator/Desktop/Project/Github/warzone-ticketing-system/resources/views/admin/seats/create.blade.php ENDPATH**/ ?>
...
@section('page-title', 'Create Price Zone')
    ...
    <div class="px-6 py-6">
        <div class="mx-auto">
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-wwc-neutral-200">
                ...
                <div class="p-6">
                    <form action="{{ route('admin.price-zones.store') }}" method="POST">
                        @csrf
                            ...
                            <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                                ...
                                <div>
                                    ...
                                    <select name="color" id="color" required
                                        ...
                                        <option value="text-orange-600" {{ old('color') == 'text-orange-600' ? 'selected' : '' }}>Orange</option>
                                    </select>
                                    @error('color')
                                        <div class="text-wwc-error text-xs mt-1 font-medium">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="sm:col-span-2">
                                    ...
                                    <textarea name="description" id="description" rows="3"
                                              ...
                                              placeholder="Enter price zone description">{{ old('description') }}</textarea>
                                    @error('description')
                                        <div class="text-wwc-error text-xs mt-1 font-medium">{{ $message }}</div>
                                    @enderror
                                </div>

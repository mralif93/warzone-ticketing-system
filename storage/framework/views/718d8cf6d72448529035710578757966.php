                ...
                <nav class="flex-1 px-6 py-8 space-y-2">
                    ...
                    <a href="<?php echo e(route('admin.seats.index')); ?>" 
                       class="group flex items-center px-4 py-4 text-sm font-semibold rounded-xl transition-all duration-300 <?php echo e(request()->routeIs('admin.seats*') ? 'bg-gradient-to-r from-wwc-primary-light to-red-100 text-wwc-primary shadow-lg border border-red-200' : 'text-wwc-neutral-600 hover:bg-wwc-neutral-50 hover:text-wwc-neutral-900 hover:shadow-md'); ?>">
                        <div class="flex-shrink-0 mr-4">
                            <div class="h-10 w-10 rounded-xl flex items-center justify-center <?php echo e(request()->routeIs('admin.seats*') ? 'bg-wwc-primary-light' : 'bg-wwc-neutral-100 group-hover:bg-wwc-neutral-200'); ?> transition-colors duration-300">
                                <i class='bx bx-chair text-lg <?php echo e(request()->routeIs('admin.seats*') ? 'text-wwc-primary' : 'text-wwc-neutral-500 group-hover:text-wwc-neutral-700'); ?>'></i>
                            </div>
                        </div>
                        <div class="flex-1">
                        ...
                        <?php if(request()->routeIs('admin.seats*')): ?>
                        <div class="h-2 w-2 bg-wwc-primary rounded-full"></div>
                        <?php endif; ?>
                    </a>
                    ...
                    <a href="<?php echo e(route('admin.price-zones.index')); ?>" 
                       class="group flex items-center px-4 py-4 text-sm font-semibold rounded-xl transition-all duration-300 <?php echo e(request()->routeIs('admin.price-zones*') ? 'bg-gradient-to-r from-wwc-primary-light to-red-100 text-wwc-primary shadow-lg border border-red-200' : 'text-wwc-neutral-600 hover:bg-wwc-neutral-50 hover:text-wwc-neutral-900 hover:shadow-md'); ?>">
                        <div class="flex-shrink-0 mr-4">
                            <div class="h-10 w-10 rounded-xl flex items-center justify-center <?php echo e(request()->routeIs('admin.price-zones*') ? 'bg-wwc-primary-light' : 'bg-wwc-neutral-100 group-hover:bg-wwc-neutral-200'); ?> transition-colors duration-300">
                                <i class='bx bx-tag text-lg <?php echo e(request()->routeIs('admin.price-zones*') ? 'text-wwc-primary' : 'text-wwc-neutral-500 group-hover:text-wwc-neutral-700'); ?>'></i>
                            </div>
                        </div>
                        <div class="flex-1">
                        ...
                        <?php if(request()->routeIs('admin.price-zones*')): ?>
                        <div class="h-2 w-2 bg-wwc-primary rounded-full"></div>
                        <?php endif; ?>
                    </a>

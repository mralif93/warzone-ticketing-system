                            ...
                            <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="section" id="section" required
                                           value="{{ old('section', $seat->section) }}"
                                ...
                                <div>
                                    ...
                                    <select name="price_zone" id="price_zone" required
                                        ...
                                        <option value="VIP" {{ old('price_zone', $seat->price_zone) == 'VIP' ? 'selected' : '' }}>VIP</option>
                                        <option value="Premium" {{ old('price_zone', $seat->price_zone) == 'Premium' ? 'selected' : '' }}>Premium</option>
                                        <option value="Standard" {{ old('price_zone', $seat->price_zone) == 'Standard' ? 'selected' : '' }}>Standard</option>
                                        <option value="Economy" {{ old('price_zone', $seat->price_zone) == 'Economy' ? 'selected' : '' }}>Economy</option>
                                    </select>
                                    @error('price_zone')
                                        <div class="text-wwc-error text-xs mt-1 font-medium">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="sm:col-span-2">
                                    <label class="flex items-center">
                                        <input type="checkbox" name="is_accessible" value="1" 
                                               {{ old('is_accessible', $seat->is_accessible) ? 'checked' : '' }}

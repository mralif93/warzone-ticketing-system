                            ...
                            <div class="space-y-4">
                                ...
                                <div class="flex items-center py-3 border-b border-wwc-neutral-100">
                                    ...
                                    <div class="flex-1 flex items-center justify-between">
                                        ...
                                        <span class="text-base font-medium text-wwc-neutral-900">{{ $seat->seat_identifier }}</span>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-center py-3 border-b border-wwc-neutral-100">
                                    ...
                                    <div class="flex-1 flex items-center justify-between">
                                        ...
                                        <span class="text-base font-medium text-wwc-neutral-900">{{ $seat->section }}</span>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-center py-3 border-b border-wwc-neutral-100">
                                    ...
                                    <div class="flex-1 flex items-center justify-between">
                                        ...
                                        <span class="text-base font-medium text-wwc-neutral-900">{{ $seat->row }}</span>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-center py-3 border-b border-wwc-neutral-100">
                                    ...
                                    <div class="flex-1 flex items-center justify-between">
                                        ...
                                        <span class="text-base font-medium text-wwc-neutral-900">{{ $seat->number }}</span>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-center py-3 border-b border-wwc-neutral-100">
                                    ...
                                    <div class="flex-1 flex items-center justify-between">
                                        ...
                                        <span class="text-base font-medium text-wwc-neutral-900">{{ $seat->price_zone }}</span>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-center py-3 border-b border-wwc-neutral-100">
                                    ...
                                    <div class="flex-1 flex items-center justify-between">
                                        ...
                                        <span class="text-base font-medium text-wwc-neutral-900">RM{{ number_format($seat->base_price, 0) }}</span>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-center py-3 border-b border-wwc-neutral-100">
                                    ...
                                    <div class="flex-1 flex items-center justify-between">
                                        ...
                                        <span class="text-base font-medium text-wwc-neutral-900">{{ $seat->seat_type }}</span>
                                    </div>
                                </div>
                        ...
                        <div class="p-6">
                            <div class="space-y-4">
                                ...
                                <div class="text-center">
                                    <div class="text-2xl font-bold text-wwc-neutral-900">{{ $seat->created_at->format('M d, Y') }}</div>
                                    <div class="text-sm text-wwc-neutral-500">Created Date</div>
                                </div>
                                <!-- Updated Date -->
                                <div class="text-center">
                                    <div class="text-2xl font-bold text-wwc-neutral-900">{{ $seat->updated_at->format('M d, Y') }}</div>

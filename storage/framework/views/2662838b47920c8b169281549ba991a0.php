<?php $__env->startSection('title', 'Create Price Zone'); ?>
<?php $__env->startSection('page-title', 'Create Price Zone'); ?>

<?php $__env->startSection('content'); ?>
<!-- Professional Price Zone Creation with WWC Brand Design -->
    ...
    <div class="px-6 py-6">
        <div class="mx-auto">
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-wwc-neutral-200">
                ...
                <div class="p-6">
                    <form action="<?php echo e(route('admin.price-zones.store')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div>
                                    ...
                                    <input type="text" name="code" id="code" required
                                           ...
                                           class="block w-full px-3 py-2 border border-wwc-neutral-300 rounded-lg shadow-sm focus:ring-2 focus:ring-wwc-primary focus:border-wwc-primary text-sm <?php $__errorArgs = ['code'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-wwc-error focus:ring-wwc-error focus:border-wwc-error <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div>
                                    ...
                                    <select name="category" id="category" required
                                            class="block w-full px-3 py-2 border border-wwc-neutral-300 rounded-lg shadow-sm focus:ring-2 focus:ring-wwc-primary focus:border-wwc-primary text-sm <?php $__errorArgs = ['category'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-wwc-error focus:ring-wwc-error focus:border-wwc-error <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div>
                                    ...
                                    <select name="color" id="color" required
                                            class="block w-full px-3 py-2 border border-wwc-neutral-300 rounded-lg shadow-sm focus:ring-2 focus:ring-wwc-primary focus:border-wwc-primary text-sm <?php $__errorArgs = ['color'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-wwc-error focus:ring-wwc-error focus:border-wwc-error <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                                        ...
                                        <option value="text-blue-600" <?php echo e(old('color') == 'text-blue-600' ? 'selected' : ''); ?>>Blue</option>
                                        <option value="text-green-600" <?php echo e(old('color') == 'text-green-600' ? 'selected' : ''); ?>>Green</option>
                                        <option value="text-yellow-600" <?php echo e(old('color') == 'text-yellow-600' ? 'selected' : ''); ?>>Yellow</option>
                                        <option value="text-red-600" <?php echo e(old('color') == 'text-red-600' ? 'selected' : ''); ?>>Red</option>
                                        <option value="text-purple-600" <?php echo e(old('color') == 'text-purple-600' ? 'selected' : ''); ?>>Purple</option>
                                        <option value="text-indigo-600" <?php echo e(old('color') == 'text-indigo-600' ? 'selected' : ''); ?>>Indigo</option>
                                        <option value="text-pink-600" <?php echo e(old('color') == 'text-pink-600' ? 'selected' : ''); ?>>Pink</option>
                                        <option value="text-orange-600" <?php echo e(old('color') == 'text-orange-600' ? 'selected' : ''); ?>>Orange</option>
                                    </select>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div>
                                    ...
                                    <input type="text" name="icon" id="icon"
                                           ...
                                           class="block w-full px-3 py-2 border border-wwc-neutral-300 rounded-lg shadow-sm focus:ring-2 focus:ring-wwc-primary focus:border-wwc-primary text-sm <?php $__errorArgs = ['icon'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-wwc-error focus:ring-wwc-error focus:border-wwc-error <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div>
                                    ...
                                    <input type="number" name="sort_order" id="sort_order" min="0"
                                           ...
                                           class="block w-full px-3 py-2 border border-wwc-neutral-300 rounded-lg shadow-sm focus:ring-2 focus:ring-wwc-primary focus:border-wwc-primary text-sm <?php $__errorArgs = ['sort_order'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-wwc-error focus:ring-wwc-error focus:border-wwc-error <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                              placeholder="Enter price zone description"><?php echo e(old('description')); ?></textarea>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/administrator/Desktop/Project/Github/warzone-ticketing-system/resources/views/admin/price-zones/create.blade.php ENDPATH**/ ?>
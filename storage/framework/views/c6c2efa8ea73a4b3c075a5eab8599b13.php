...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div>
                                    ...
                                    <input type="password" name="password" id="password" required
                                           class="block w-full px-3 py-2 border border-wwc-neutral-300 rounded-lg shadow-sm focus:ring-2 focus:ring-wwc-primary focus:border-wwc-primary text-sm <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-wwc-error focus:ring-wwc-error focus:border-wwc-error <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                                        ...
                                        <option value="Gate Staff" <?php echo e(old('role') == 'Gate Staff' ? 'selected' : ''); ?>>Gate Staff</option>
                                        <option value="Counter Staff" <?php echo e(old('role') == 'Counter Staff' ? 'selected' : ''); ?>>Counter Staff</option>
                                        <option value="Support Staff" <?php echo e(old('role') == 'Support Staff' ? 'selected' : ''); ?>>Support Staff</option>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div>
                                    ...
                                    <input type="tel" name="phone_number" id="phone_number" value="<?php echo e(old('phone_number')); ?>"
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="sm:col-span-2">
                                    ...
                                    <input type="text" name="address_line_1" id="address_line_1" value="<?php echo e(old('address_line_1')); ?>"
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div>
                                    ...
                                    <input type="text" name="postcode" id="postcode" value="<?php echo e(old('postcode')); ?>"
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/administrator/Desktop/Project/Github/warzone-ticketing-system/resources/views/admin/users/create.blade.php ENDPATH**/ ?>
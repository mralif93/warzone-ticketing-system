<?php $__env->startSection('title', 'Select Seats - ' . $event->name); ?>
<?php $__env->startSection('description', 'Select your seats for ' . $event->name . ' on ' . $event->date_time->format('M j, Y') . ' at ' . ($event->venue ?? 'TBA venue') . '.'); ?>
    ...
    <div class="bg-white border-b border-gray-200">
        <div class="max-w-6xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between">
                <div class="flex items-center">
                    <a href="<?php echo e(route('public.events.show', $event)); ?>" class="text-gray-500 hover:text-gray-700 mr-6 transition-colors duration-200">
                        <div class="flex items-center">
                    ...
                    <div>
                        ...
                        <p class="text-gray-600 text-sm"><?php echo e($event->date_time->format('M j, Y \a\t g:i A')); ?> • <?php echo e($event->venue ?? 'Venue TBA'); ?></p>
                    </div>
                </div>
                <div class="text-right">
                    ...
                    <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium
                        ...
                        <?php elseif($event->status === 'Sold Out'): ?> bg-red-100 text-red-800
                    ...
                    <div class="p-6">
                        ...
                        <div class="mb-8">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <?php $__currentLoopData = $premiumZones; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $zone => $stats): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="price-zone-option group border-2 border-gray-200 rounded-lg p-4 cursor-pointer hover:border-wwc-primary hover:shadow-md transition-all duration-200" 
                                         data-zone="<?php echo e($zone); ?>" 
                                         data-available="<?php echo e($stats['available']); ?>"
                                         data-price="<?php echo e(\App\Models\Seat::where('price_zone', $zone)->first()->base_price ?? 0); ?>">
                                        <div class="flex justify-between items-start">
                                            <div class="flex-1">
                                                <div class="flex items-center justify-between mb-3">
                                                    <h4 class="text-lg font-semibold text-gray-900 group-hover:text-wwc-primary transition-colors duration-200"><?php echo e($zone); ?></h4>
                                                    <span class="px-2 py-1 bg-amber-100 text-amber-800 text-xs font-medium rounded-full"><?php echo e(number_format($stats['available'])); ?> available</span>
                                                </div>
                                                <div class="w-full bg-gray-200 rounded-full h-2 mb-2">
                                                    <div class="bg-wwc-primary h-2 rounded-full transition-all duration-300" style="width: <?php echo e(100 - $stats['sold_percentage']); ?>%"></div>
                                                </div>
                                                <p class="text-xs text-gray-500"><?php echo e($stats['sold_percentage']); ?>% sold</p>
                                            </div>
                                            <div class="text-right ml-4">
                                                <div class="text-2xl font-bold text-wwc-primary group-hover:text-wwc-primary-dark transition-colors duration-200">RM<?php echo e(number_format(\App\Models\Seat::where('price_zone', $zone)->first()->base_price ?? 0, 0)); ?></div>
                        ...
                        <div class="mb-8">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <?php $__currentLoopData = $levelZones; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $zone => $stats): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="price-zone-option group border-2 border-gray-200 rounded-lg p-4 cursor-pointer hover:border-wwc-primary hover:shadow-md transition-all duration-200" 
                                         data-zone="<?php echo e($zone); ?>" 
                                         data-available="<?php echo e($stats['available']); ?>"
                                         data-price="<?php echo e(\App\Models\Seat::where('price_zone', $zone)->first()->base_price ?? 0); ?>">
                                        <div class="flex justify-between items-start">
                                            <div class="flex-1">
                                                <div class="flex items-center justify-between mb-3">
                                                    <h4 class="text-lg font-semibold text-gray-900 group-hover:text-wwc-primary transition-colors duration-200"><?php echo e($zone); ?></h4>
                                                    <span class="px-2 py-1 bg-blue-100 text-blue-800 text-xs font-medium rounded-full"><?php echo e(number_format($stats['available'])); ?> available</span>
                                                </div>
                                                <div class="w-full bg-gray-200 rounded-full h-2 mb-2">
                                                    <div class="bg-wwc-primary h-2 rounded-full transition-all duration-300" style="width: <?php echo e(100 - $stats['sold_percentage']); ?>%"></div>
                                                </div>
                        ...
                        <div class="mb-8">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <?php $__currentLoopData = $standingZones; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $zone => $stats): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="price-zone-option group border-2 border-gray-200 rounded-lg p-4 cursor-pointer hover:border-wwc-primary hover:shadow-md transition-all duration-200" 
                                         data-zone="<?php echo e($zone); ?>" 
                                         data-available="<?php echo e($stats['available']); ?>"
                                         data-price="<?php echo e(\App\Models\Seat::where('price_zone', $zone)->first()->base_price ?? 0); ?>">
                                        <div class="flex justify-between items-start">
                                            <div class="flex-1">
                                                <div class="flex items-center justify-between mb-3">
                                                    <h4 class="text-lg font-semibold text-gray-900 group-hover:text-wwc-primary transition-colors duration-200"><?php echo e($zone); ?></h4>
                                                    <span class="px-2 py-1 bg-green-100 text-green-800 text-xs font-medium rounded-full"><?php echo e(number_format($stats['available'])); ?> available</span>
                                                </div>
                                                <div class="w-full bg-gray-200 rounded-full h-2 mb-2">
                                                    <div class="bg-wwc-primary h-2 rounded-full transition-all duration-300" style="width: <?php echo e(100 - $stats['sold_percentage']); ?>%"></div>
                                                </div>
                    ...
                    <div class="p-6">
                        <div class="flex items-center justify-center space-x-4">
                            ...
                            <div class="text-center">
                                <input type="number" id="quantity" min="1" max="<?php echo e($event->max_tickets_per_order); ?>" value="1" 
                                ...
                                <div class="text-xs text-gray-500 mt-1">Max <?php echo e($event->max_tickets_per_order); ?> per order</div>
                            </div>
                    ...
                    <div class="p-6">
                        <dl class="space-y-4">
                            <div>
                                ...
                                <dd class="text-sm font-semibold text-gray-900 mt-1"><?php echo e($event->date_time->format('M j, Y \a\t g:i A')); ?></dd>
                            </div>
                            <div>
                                <dt class="text-sm font-medium text-gray-500">Venue</dt>
                                <dd class="text-sm font-semibold text-gray-900 mt-1"><?php echo e($event->venue ?? 'Venue TBA'); ?></dd>
                            </div>
                            <div>
                                <dt class="text-sm font-medium text-gray-500">Max per Order</dt>
                                <dd class="text-sm font-semibold text-gray-900 mt-1"><?php echo e($event->max_tickets_per_order); ?> tickets</dd>
                            </div>
                        </dl>
                    </div>
                </div>
                        ...
                        <div class="space-y-4">
                            <div>
                                <div class="flex justify-between text-sm mb-2">
                                    ...
                                    <span class="font-semibold text-gray-900"><?php echo e(number_format($availabilityStats['total_capacity'])); ?></span>
                                </div>
                            ...
                            <div>
                                <div class="flex justify-between text-sm mb-2">
                                    ...
                                    <span class="font-semibold text-gray-900"><?php echo e(number_format($availabilityStats['available'])); ?></span>
                                </div>
                                <div class="w-full bg-gray-200 rounded-full h-2">
                                    <div class="bg-green-500 h-2 rounded-full" style="width: <?php echo e($availabilityStats['availability_percentage']); ?>%"></div>
                                </div>
                            </div>
                            ...
                            <div>
                                <div class="flex justify-between text-sm mb-2">
                                    ...
                                    <span class="font-semibold text-gray-900"><?php echo e(number_format($availabilityStats['sold'])); ?></span>
                                </div>
                                <div class="w-full bg-gray-200 rounded-full h-2">
                                    <div class="bg-wwc-primary h-2 rounded-full" style="width: <?php echo e($availabilityStats['sold_percentage']); ?>%"></div>
                                </div>
                            </div>
                        </div>
                    </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('proceed-to-checkout').addEventListener('click', function() {
        ...
        fetch(`/events/<?php echo e($event->id); ?>/find-seats`, {
            method: 'POST',
            headers: {
        ...
        .then(data => {
            if (data.success) {
                ...
                window.location.href = `/events/<?php echo e($event->id); ?>/cart`;
            } else {
                Swal.fire({
                    icon: 'error',
                    title: 'Error',
...
<?php echo $__env->make('layouts.public', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/administrator/Desktop/Project/Github/warzone-ticketing-system/resources/views/public/tickets/select.blade.php ENDPATH**/ ?>
...
@section('page-subtitle', 'Edit image for ' . $event->name . ' gallery')
    ...
    <div class="px-6 py-6">
        <div class="mx-auto max-w-3xl">
            ...
            <div class="flex justify-between items-center mb-6">
                <div>
                    <h1 class="text-2xl font-bold text-wwc-neutral-900">Edit Gallery Image</h1>
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-wwc-neutral-200">
                <form action="{{ route('admin.events.galleries.update', [$event, $gallery]) }}" 
                      method="POST" 
                    ...
                    <div class="p-6 space-y-6">
                        ...
                        <div>
                            ...
                            <div class="mt-1">
                                <img src="{{ $gallery->image_url }}" 
                                     ...
                                     class="max-w-full h-64 object-cover rounded-lg border border-wwc-neutral-200">
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <textarea id="description" 
                                      ...
                                      rows="4" 
                                      class="w-full px-4 py-2 border border-wwc-neutral-300 rounded-lg focus:ring-2 focus:ring-wwc-primary focus:border-transparent"
                                      placeholder="Enter image description (optional)">{{ old('description', $gallery->description) }}</textarea>
                            @error('description')
                            <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>

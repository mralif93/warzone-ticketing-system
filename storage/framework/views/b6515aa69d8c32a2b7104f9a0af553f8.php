...
<?php $__env->startSection('page-title', 'Ticket Details'); ?>
                            ...
                            <div class="space-y-4">
                                ...
                                <div class="flex items-center py-3 border-b border-wwc-neutral-100">
                                    ...
                                    <div class="flex-1 flex items-center justify-between">
                                        ...
                                        <span class="text-base font-medium text-wwc-neutral-900">#<?php echo e($ticket->id); ?></span>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-center py-3 border-b border-wwc-neutral-100">
                                    ...
                                    <div class="flex-1 flex items-center justify-between">
                                        ...
                                        <span class="text-base font-medium text-wwc-neutral-900 font-mono"><?php echo e($ticket->qrcode); ?></span>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-center py-3 border-b border-wwc-neutral-100">
                                    ...
                                    <div class="flex-1 flex items-center justify-between">
                                        ...
                                        <span class="text-base font-medium text-wwc-neutral-900"><?php echo e($ticket->seat->row); ?><?php echo e($ticket->seat->number); ?></span>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-center py-3 border-b border-wwc-neutral-100">
                                    ...
                                    <div class="flex-1 flex items-center justify-between">
                                        ...
                                        <span class="text-base font-medium text-wwc-neutral-900"><?php echo e($ticket->seat->price_zone); ?></span>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-center py-3 border-b border-wwc-neutral-100">
                                    ...
                                    <div class="flex-1 flex items-center justify-between">
                                        ...
                                        <span class="text-base font-medium text-wwc-neutral-900">RM<?php echo e(number_format($ticket->price_paid, 0)); ?></span>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-center py-3 border-b border-wwc-neutral-100">
                                    ...
                                    <div class="flex-1 flex items-center justify-between">
                                        ...
                                        <span class="text-base font-medium text-wwc-neutral-900"><?php echo e($ticket->status); ?></span>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-center py-3">
                                    ...
                                    <div class="flex-1 flex items-center justify-between">
                                        ...
                                        <span class="text-base font-medium text-wwc-neutral-900"><?php echo e($ticket->order->user->name); ?></span>
                                    </div>
                                </div>
                                <?php endif; ?>
                            </div>
                        ...
                        <div class="p-6">
                            <div class="space-y-6">
                                ...
                                <div class="text-center">
                                    <div class="text-3xl font-bold text-wwc-neutral-900 font-display"><?php echo e($ticket->created_at->format('M j')); ?></div>
                                ...
                                <?php if($ticket->order): ?>
                                <div class="text-center">
                                    <div class="text-3xl font-bold text-wwc-neutral-900 font-display">#<?php echo e($ticket->order->id); ?></div>
                                ...
                                <!-- Event Date -->
                                <div class="text-center">
                                    <div class="text-3xl font-bold text-wwc-neutral-900 font-display"><?php echo e($ticket->event->date_time->format('M j')); ?></div>

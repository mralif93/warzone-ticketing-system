...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Warzone World Championship'); ?> - Premium Event Tickets</title>
    <meta name="description" content="<?php echo $__env->yieldContent('description', 'Get premium tickets for the best events. Secure, fast, and reliable ticketing system for concerts, sports, and entertainment.'); ?>">
        ...
        <nav class="bg-white shadow-sm border-b border-wwc-neutral-200 sticky top-0 z-50">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex justify-between h-16">
                    ...
                    <div class="hidden md:flex items-center space-x-8">
                        ...
                        <a href="<?php echo e(route('public.contact')); ?>" 
                           class="text-wwc-neutral-600 hover:text-wwc-primary px-3 py-2 rounded-md text-sm font-medium transition-colors duration-200 <?php echo e(request()->routeIs('public.contact*') ? 'text-wwc-primary bg-wwc-primary-light' : ''); ?>">
                            Contact
                        </a>
                        <a href="<?php echo e(route('public.faq')); ?>" 
                           class="text-wwc-neutral-600 hover:text-wwc-primary px-3 py-2 rounded-md text-sm font-medium transition-colors duration-200 <?php echo e(request()->routeIs('public.faq') ? 'text-wwc-primary bg-wwc-primary-light' : ''); ?>">
                            FAQ
                        </a>
                    </div>
                        ...
                        <?php if(auth()->guard()->check()): ?>
                            ...
                            <div class="relative" x-data="{ open: false }">
                                ...
                                <div x-show="open" @click.away="open = false" x-transition class="absolute right-0 mt-2 w-48 bg-white rounded-md shadow-lg py-1 z-50 border border-wwc-neutral-200">
                                    <a href="<?php echo e(route('dashboard')); ?>" class="block px-4 py-2 text-sm text-wwc-neutral-700 hover:bg-wwc-primary-light hover:text-wwc-primary">Dashboard</a>
                                    <a href="<?php echo e(route('customer.tickets')); ?>" class="block px-4 py-2 text-sm text-wwc-neutral-700 hover:bg-wwc-primary-light hover:text-wwc-primary">My Tickets</a>
                                    <a href="<?php echo e(route('customer.orders')); ?>" class="block px-4 py-2 text-sm text-wwc-neutral-700 hover:bg-wwc-primary-light hover:text-wwc-primary">My Orders</a>
                ...
                <div x-show="mobileMenuOpen" class="md:hidden" x-data="{ mobileMenuOpen: false }">
                    <div class="px-2 pt-2 pb-3 space-y-1 sm:px-3 border-t border-wwc-neutral-200">
                        <a href="<?php echo e(route('home')); ?>" 
                        ...
                        <div class="border-t border-wwc-neutral-200 pt-4">
                            <?php if(auth()->guard()->check()): ?>
                                <div class="space-y-2">
                                    <div class="flex items-center space-x-3 px-3 py-2">
                                        ...
                                        <!-- User Name -->
                                        <span class="text-base font-medium text-wwc-primary"><?php echo e(Auth::user()->name); ?></span>
                                    </div>
                                    ...
                                    <form method="POST" action="<?php echo e(route('logout')); ?>">
                                        <?php echo csrf_field(); ?>
                                        <button type="submit" 
                                                class="w-full text-left px-3 py-2 rounded-md text-base font-medium text-wwc-neutral-600 hover:text-wwc-primary hover:bg-wwc-primary-light">
                                            Sign Out
                                        </button>
                                    </form>
                                </div>
                            <?php else: ?>
                                ...
                                <a href="<?php echo e(route('register')); ?>" 
                                   class="block px-3 py-2 rounded-md text-base font-medium text-white bg-wwc-primary hover:bg-wwc-primary-dark">
                                    Sign Up
                                </a>
                            <?php endif; ?>
                        </div>
                ...
                <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
                    ...
                    <div class="flex flex-col md:flex-row gap-8">
                        <div>
                            ...
                            <ul class="space-y-1">
                                <li><a href="<?php echo e(route('public.faq')); ?>" class="text-sm text-white hover:text-wwc-primary transition-colors duration-200">FAQ</a></li>
                                <li><a href="<?php echo e(route('public.about')); ?>" class="text-sm text-white hover:text-wwc-primary transition-colors duration-200">About Us</a></li>
                                <li><a href="<?php echo e(route('public.contact')); ?>" class="text-sm text-white hover:text-wwc-primary transition-colors duration-200">Contact</a></li>
                            </ul>
                        </div>
                        ...
                        <div>
                            ...
                            <ul class="space-y-1">
                                <li><a href="<?php echo e(route('public.terms-of-service')); ?>" class="text-sm text-white hover:text-wwc-primary transition-colors duration-200">Terms of Service</a></li>
                                <li><a href="<?php echo e(route('public.refund-policy')); ?>" class="text-sm text-white hover:text-wwc-primary transition-colors duration-200">Refund Policy</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
...
<?php /**PATH /Users/administrator/Desktop/Project/Github/warzone-ticketing-system/resources/views/layouts/public.blade.php ENDPATH**/ ?>
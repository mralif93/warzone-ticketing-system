            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        ...
                        <p class="text-gray-500 text-sm">Order #<?php echo e($order->order_number); ?></p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="lg:col-span-2 space-y-8">
                ...
                <div class="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
                    <div class="px-6 py-4 border-b border-gray-200">
                        <div class="flex items-center justify-between">
                            <div>
                                <h2 class="text-lg font-semibold text-gray-900"><?php echo e($order->tickets->first()->event->name ?? 'Order Details'); ?></h2>
                                <p class="text-gray-500 text-sm mt-1">Order Information</p>
                            </div>
                            <div class="text-right">
                                <div class="text-xl font-semibold text-gray-900">RM<?php echo e(number_format($order->total_amount, 0)); ?></div>
                    ...
                    <div class="p-6">
                        <div class="space-y-4">
                            <div class="flex items-center justify-between">
                                ...
                                <p class="text-sm text-gray-900 font-medium"><?php echo e($order->order_number); ?></p>
                            </div>
                            <div class="flex items-center justify-between">
                                <div class="flex items-center space-x-3">
                                ...
                                <p class="text-sm text-gray-900 font-medium"><?php echo e($order->created_at->format('M j, Y \a\t g:i A')); ?></p>
                            </div>
                            <div class="flex items-center justify-between">
                                <div class="flex items-center space-x-3">
                            ...
                            <div class="flex items-center justify-between">
                                ...
                                <p class="text-sm text-gray-900 font-medium"><?php echo e($order->tickets->count()); ?> ticket(s)</p>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="space-y-4">
                                ...
                                <div class="flex items-center justify-between">
                                    ...
                                    <p class="text-sm text-gray-900 font-medium">TKT-<?php echo e($ticket->id); ?></p>
                                </div>
                                <div class="flex items-center justify-between">
                                    <div class="flex items-center space-x-3">
                                    ...
                                    <p class="text-sm text-gray-900 font-medium"><?php echo e($ticket->zone ?? 'General'); ?></p>
                                </div>
                                <div class="flex items-center justify-between">
                                    <div class="flex items-center space-x-3">
                                    ...
                                    <p class="text-sm text-gray-900 font-medium">#<?php echo e($ticket->id); ?></p>
                                </div>
                                <div class="flex items-center justify-between">
                                    <div class="flex items-center space-x-3">
...
<?php echo $__env->make('layouts.customer', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/administrator/Desktop/Project/Github/warzone-ticketing-system/resources/views/customer/order-details.blade.php ENDPATH**/ ?>
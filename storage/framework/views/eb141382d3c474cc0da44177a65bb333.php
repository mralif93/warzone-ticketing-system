            ...
            <div class="bg-white rounded-xl shadow-sm border border-wwc-neutral-200 p-6 hover:shadow-md transition-shadow duration-200">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-bold text-wwc-neutral-900"><?php echo e($orderStats['total_orders']); ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-wwc-neutral-200 p-6 hover:shadow-md transition-shadow duration-200">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-bold text-wwc-neutral-900"><?php echo e($orderStats['total_tickets']); ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-wwc-neutral-200 p-6 hover:shadow-md transition-shadow duration-200">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-bold text-wwc-neutral-900">RM<?php echo e(number_format($orderStats['total_spent'], 0)); ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-wwc-neutral-200 p-6 hover:shadow-md transition-shadow duration-200">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-bold text-wwc-neutral-900"><?php echo e($orderStats['upcoming_events']); ?></p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-wwc-neutral-200">
                ...
                <div class="p-6">
                    <?php if($recentTickets->count() > 0): ?>
                        <div class="space-y-4">
                            <?php $__currentLoopData = $recentTickets->take(3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ticket): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <?php if($upcomingEvents->count() > 0): ?>
                        <div class="space-y-4">
                            ...
                            <div class="flex items-center p-4 bg-wwc-neutral-50 rounded-lg hover:bg-wwc-neutral-100 transition-colors duration-200">
                                ...
                                <div class="ml-4 flex-1 min-w-0">
                                    <h3 class="text-sm font-semibold text-wwc-neutral-900 truncate"><?php echo e($event->name); ?></h3>
                                    <p class="text-xs text-wwc-neutral-500"><?php echo e($event->date_time->format('M j, Y \a\t g:i A')); ?> • <?php echo e($event->venue); ?></p>
                                </div>
                                <div class="flex-shrink-0">

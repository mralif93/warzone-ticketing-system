                ...
                <div class="flex justify-between h-16">
                    ...
                    <div class="hidden md:flex items-center space-x-8">
                        ...
                        <a href="{{ route('public.events') }}" 
                           class="text-wwc-neutral-600 hover:text-wwc-primary px-3 py-2 rounded-md text-sm font-medium transition-colors duration-200 {{ request()->routeIs('public.events*') ? 'text-wwc-primary bg-wwc-primary-light' : '' }}">
                            Events
                        </a>
                            ...
                            @auth
                                <div class="space-y-2">
                                    <div class="flex items-center space-x-3 px-3 py-2">
                                        ...
                                        <!-- User Name -->
                                        <span class="text-base font-medium text-wwc-primary">{{ Auth::user()->name }}</span>
                                    </div>

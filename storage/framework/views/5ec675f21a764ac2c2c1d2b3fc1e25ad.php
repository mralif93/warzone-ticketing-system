                            ...
                            <div class="space-y-4">
                                ...
                                <div class="flex items-center py-3 border-b border-wwc-neutral-100">
                                    ...
                                    <div class="flex-1 flex items-center justify-between">
                                        ...
                                        <span class="text-base font-medium text-wwc-neutral-900">RM<?php echo e(number_format($correctedTotal, 2)); ?></span>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-center py-3">
                                    ...
                                    <div class="flex-1">
                                        ...
                                        <p class="text-base font-medium text-wwc-neutral-900 mt-1"><?php echo e($order->notes); ?></p>
                                    </div>
                                </div>
                                <?php endif; ?>
                            </div>
                                            ...
                                            <div class="flex items-center space-x-3">
                                                ...
                                                <div>
                                                    <h4 class="text-sm font-semibold text-wwc-neutral-900">
                                                        <?php echo e($ticketData['ticket']->name ?? 'N/A'); ?> 
                                                        <?php if($ticketData['quantity'] > 1): ?>
                                                            <span class="text-xs text-wwc-neutral-600">x <?php echo e($ticketData['quantity']); ?></span>
                                                        <?php endif; ?>
                                                    </h4>
                                                    <p class="text-xs text-wwc-neutral-600"><?php echo e($ticketData['event']->name ?? 'N/A'); ?></p>
                                                    <?php if($ticketData['day_name']): ?>
                                                        <p class="text-xs text-wwc-neutral-500"><?php echo e($ticketData['day_name']); ?> - <?php echo e($ticketData['event']->getEventDays()[$ticketData['day']-1]['display'] ?? ''); ?></p>
                                                    <?php else: ?>
                                                        <p class="text-xs text-wwc-neutral-500"><?php echo e($ticketData['event']->getFormattedDateRange() ?? 'N/A'); ?></p>
                                                    <?php endif; ?>
                                                </div>
                                            </div>
                                            <div class="text-right">
                                                <p class="text-lg font-bold text-wwc-neutral-900">RM<?php echo e(number_format($ticketData['price'] * $ticketData['quantity'], 2)); ?></p>
                                                <?php if($ticketData['quantity'] > 1): ?>
                                                    <p class="text-xs text-wwc-neutral-500">RM<?php echo e(number_format($ticketData['price'], 2)); ?> each</p>
                                                <?php endif; ?>
                                                <span class="inline-flex items-center px-2 py-1 rounded-full text-xs font-semibold
                                                    <?php if($ticketData['status'] === 'sold'): ?> bg-green-100 text-green-800
                                                    <?php elseif($ticketData['status'] === 'scanned'): ?> bg-blue-100 text-blue-800
                                                    <?php elseif($ticketData['status'] === 'pending'): ?> bg-yellow-100 text-yellow-800
                                                    <?php elseif($ticketData['status'] === 'cancelled'): ?> bg-red-100 text-red-800
                                                    <?php else: ?> bg-gray-100 text-gray-800
                                                    <?php endif; ?>">
                                                    <?php echo e(ucwords($ticketData['status'])); ?>

                                                </span>
                                            </div>
                                        </div>
                                        <?php if($ticketData['day_name'] && $ticketData['day']): ?>
                    ...
                    <div class="px-6 py-4 border-b border-wwc-neutral-100">
                        ...
                        <div class="p-6 space-y-4">
                            ...
                            <div class="flex items-center justify-between">
                                ...
                                <span class="text-base font-medium text-wwc-neutral-900">RM<?php echo e(number_format($originalSubtotal, 2)); ?></span>
                            </div>
                            
                            <div class="flex items-center justify-between">
                                <span class="text-sm font-semibold text-wwc-neutral-600">Combo Discount (<?php echo e(number_format($order->event->getComboDiscountPercentage(), 2)); ?>%)</span>
                                <span class="text-base font-medium text-green-600">-RM<?php echo e(number_format($comboDiscountAmount, 2)); ?></span>
                            </div>
                            
                            <div class="flex items-center justify-between">
                                <span class="text-sm font-semibold text-wwc-neutral-600">Service Fee (<?php echo e($serviceFeePercentage); ?>%)</span>
                                <span class="text-base font-medium text-wwc-neutral-900">RM<?php echo e(number_format($serviceFeePercentage == 0 ? 0 : $order->service_fee, 2)); ?></span>
                            </div>
                            <div class="flex items-center justify-between">
                                <span class="text-sm font-semibold text-wwc-neutral-600">Tax (<?php echo e($taxPercentage); ?>%)</span>
                                <span class="text-base font-medium text-wwc-neutral-900">RM<?php echo e(number_format($taxPercentage == 0 ? 0 : $order->tax_amount, 2)); ?></span>
                            </div>
                            <div class="border-t border-wwc-neutral-200 pt-4">
                                <div class="flex items-center justify-between">
                                    <span class="text-lg font-bold text-wwc-neutral-900">Total</span>
                                    <span class="text-xl font-bold text-wwc-neutral-900">RM<?php echo e(number_format($correctedTotal, 2)); ?></span>
                                </div>
                            </div>
                                </div>
                            </div>
                    ...
                    <div class="bg-white rounded-2xl shadow-sm border border-wwc-neutral-200">
                        ...
                        <div class="p-6 space-y-4">
                            ...
                            <div class="flex items-center justify-between">
                                ...
                                <span class="text-base font-medium text-wwc-neutral-900"><?php echo e($order->user->email ?? 'N/A'); ?></span>
                            </div>

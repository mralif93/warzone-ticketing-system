        ...
        <div class="mx-auto">
            ...
            <div class="flex justify-between items-center mb-6">
                <div class="flex items-center">
                    ...
                    <div>
                        <h1 class="text-2xl font-bold text-wwc-neutral-900 font-display">{{ $event->name }}</h1>
                        <p class="mt-1 text-sm text-wwc-neutral-600 font-medium">{{ $event->date_time->format('M j, Y \a\t g:i A') }} • {{ $event->venue }}</p>
                    </div>
                </div>

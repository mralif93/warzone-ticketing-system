...
@section('content')
<!-- Professional User Creation with WWC Brand Design -->
                            ...
                            <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                                ...
                                <div>
                                    <label for="password" class="block text-sm font-semibold text-wwc-neutral-900 mb-2">
                                        Password <span class="text-wwc-error">*</span>
                                    </label>
                                    <input type="password" name="password" id="password" required
                                           class="block w-full px-3 py-2 border border-wwc-neutral-300 rounded-lg shadow-sm focus:ring-2 focus:ring-wwc-primary focus:border-wwc-primary text-sm @error('password') border-wwc-error focus:ring-wwc-error focus:border-wwc-error @enderror"
                                ...
                                <div>
                                    <label for="password_confirmation" class="block text-sm font-semibold text-wwc-neutral-900 mb-2">
                                        Confirm Password <span class="text-wwc-error">*</span>
                                    </label>

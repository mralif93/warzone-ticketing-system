...
<?php $__env->startSection('page-subtitle', 'Business insights and performance metrics'); ?>
        ...
        <div class="mx-auto">
            ...
            <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4 mb-6">
                        ...
                        <div>
                            ...
                            <div class="flex items-center">
                                <div class="flex items-center text-xs text-wwc-success font-semibold">
                                    ...
                                    <?php echo e($revenueData->count()); ?> days
                                </div>
                            </div>
                        </div>
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-wwc-neutral-200 p-4">
                    <div class="flex items-center justify-between">
                        <div>
                            <div class="text-2xl font-bold text-wwc-neutral-900 mb-1"><?php echo e($ticketSalesByEvent->sum('count')); ?></div>
                            <div class="text-xs text-wwc-neutral-600 mb-2 font-medium">Tickets Sold</div>
                            <div class="flex items-center">
                                <div class="flex items-center text-xs text-wwc-success font-semibold">
                                    <i class='bx bx-check text-xs mr-1'></i>
                                    <?php echo e($ticketSalesByEvent->count()); ?> events
                                </div>
                            </div>
                        </div>
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-wwc-neutral-200 p-4">
                    <div class="flex items-center justify-between">
                        <div>
                            <div class="text-2xl font-bold text-wwc-neutral-900 mb-1"><?php echo e($usersByRole->sum('count')); ?></div>
                            ...
                            <div class="flex items-center">
                                <div class="flex items-center text-xs text-wwc-warning font-semibold">
                                    ...
                                    <?php echo e($userRegistrations->sum('count')); ?> new
                                </div>
                            </div>
                        </div>
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-wwc-neutral-200 p-4">
                    <div class="flex items-center justify-between">
                        <div>
                            <div class="text-2xl font-bold text-wwc-neutral-900 mb-1"><?php echo e(\App\Models\Event::where('status', 'On Sale')->count()); ?></div>
                            ...
                            <div class="flex items-center">
                                <div class="flex items-center text-xs text-wwc-accent font-semibold">
                                    ...
                                    <?php echo e(\App\Models\Event::count()); ?> total
                                </div>
                            </div>
                        </div>
                ...
                <div class="p-6">
                    <form method="GET" class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
                        ...
                        <div class="sm:col-span-2 lg:col-span-4 flex justify-end gap-3">
                            ...
                            <a href="<?php echo e(route('admin.reports.export', ['type' => 'revenue', 'date_from' => $dateFrom, 'date_to' => $dateTo])); ?>" 
                               class="inline-flex items-center px-4 py-2 border border-wwc-neutral-300 shadow-sm text-sm font-semibold rounded-lg text-wwc-neutral-700 bg-white hover:bg-wwc-neutral-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-wwc-primary transition-colors duration-200">
            ...
            <div class="grid grid-cols-1 gap-6 lg:grid-cols-2 mb-6">
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-wwc-neutral-200">
                    ...
                    <div class="p-6">
                        <?php if($revenueData->count() > 0): ?>
                            <div class="space-y-3">
                                <?php $__currentLoopData = $revenueData->take(10); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="flex items-center justify-between py-2 border-b border-wwc-neutral-100 last:border-b-0">
                                    <div class="text-sm text-wwc-neutral-900"><?php echo e(\Carbon\Carbon::parse($data->date)->format('M d, Y')); ?></div>
                                    <div class="text-sm font-semibold text-wwc-neutral-900">RM<?php echo e(number_format($data->total, 0)); ?></div>
                                </div>
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-wwc-neutral-200">
                    ...
                    <div class="p-6">
                        <?php if($userRegistrations->count() > 0): ?>
                            <div class="space-y-3">
                                <?php $__currentLoopData = $userRegistrations->take(10); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="flex items-center justify-between py-2 border-b border-wwc-neutral-100 last:border-b-0">
                                    <div class="text-sm text-wwc-neutral-900"><?php echo e(\Carbon\Carbon::parse($data->date)->format('M d, Y')); ?></div>
                                    <div class="text-sm font-semibold text-wwc-neutral-900"><?php echo e($data->count); ?> users</div>
                                </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </div>
                        <?php else: ?>
                ...
                <div class="px-6 py-4 border-b border-wwc-neutral-100">
                    <div class="flex items-center justify-between">
                        ...
                        <div class="flex items-center space-x-2 text-xs text-wwc-neutral-500">
                            ...
                            <span><?php echo e($ticketSalesByEvent->count()); ?> events</span>
                        </div>
                    </div>
                </div>
                <div class="p-6">
                    <?php if($ticketSalesByEvent->count() > 0): ?>
                        <div class="space-y-4">
                            <?php $__currentLoopData = $ticketSalesByEvent; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $event): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="flex items-center justify-between py-3 border-b border-wwc-neutral-100 last:border-b-0">
                                <div class="flex items-center">
                                    ...
                                    <div>
                                        <div class="text-sm font-semibold text-wwc-neutral-900"><?php echo e($event->title); ?></div>
                                        <div class="text-xs text-wwc-neutral-500"><?php echo e($event->event_date->format('M d, Y')); ?></div>
                                    </div>
                                </div>
                                <div class="text-right">
                                    <div class="text-sm font-semibold text-wwc-neutral-900"><?php echo e($event->count); ?> tickets</div>
                                    <div class="text-xs text-wwc-neutral-500">RM<?php echo e(number_format($event->revenue, 0)); ?></div>
                                </div>
                            </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
                                ...
                                <div class="flex items-center justify-between">
                                    <div class="flex items-center">
                                        <div class="flex-shrink-0 h-3 w-3 rounded-full
                                            <?php if($role->role === 'Administrator'): ?> bg-red-400
                                            <?php elseif($role->role === 'Gate Staff'): ?> bg-blue-400
                                            <?php elseif($role->role === 'Counter Staff'): ?> bg-green-400
                                            <?php elseif($role->role === 'Support Staff'): ?> bg-yellow-400
                                            <?php else: ?> bg-gray-400
                                            <?php endif; ?>">
                                        </div>
                                        <div class="ml-3">
                                            <div class="text-sm font-semibold text-wwc-neutral-900"><?php echo e($role->role); ?></div>
                                        </div>
                                    </div>
                                    <div class="text-sm font-semibold text-wwc-neutral-900"><?php echo e($role->count); ?> users</div>
                                </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </div>
                        <?php else: ?>
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-wwc-neutral-200">
                    ...
                    <div class="p-6">
                        <?php if($topCustomers->count() > 0): ?>
                            <div class="space-y-4">
                                <?php $__currentLoopData = $topCustomers->take(5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $customer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="flex items-center justify-between">
                                    <div class="flex items-center">
                                        ...
                                        <div>
                                            <div class="text-sm font-semibold text-wwc-neutral-900"><?php echo e($customer->name); ?></div>
                                            <div class="text-xs text-wwc-neutral-500"><?php echo e($customer->orders_count); ?> orders</div>
                                        </div>
                                    </div>
                                    <div class="text-sm font-semibold text-wwc-neutral-900">RM<?php echo e(number_format($customer->orders_sum_total_amount, 0)); ?></div>
                                </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </div>
                        <?php else: ?>
                            ...
                            <table class="min-w-full divide-y divide-wwc-neutral-200">
                                ...
                                <tbody class="bg-white divide-y divide-wwc-neutral-200">
                                    ...
                                    <tr class="hover:bg-wwc-neutral-50 transition-colors duration-150">
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-semibold text-wwc-neutral-900"><?php echo e($trend['month']); ?></td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-wwc-neutral-900 text-right">RM<?php echo e(number_format($trend['revenue'], 0)); ?></td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-wwc-neutral-900 text-right"><?php echo e($trend['tickets']); ?></td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-wwc-neutral-900 text-right"><?php echo e($trend['users']); ?></td>
                                    </tr>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </tbody>
                            </table>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/administrator/Desktop/Project/Github/warzone-ticketing-system/resources/views/admin/reports/index.blade.php ENDPATH**/ ?>
...
@section('description', 'View detailed information about your ticket in your Warzone World Championship customer portal.')
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
            <div class="flex items-center justify-between">
                <div class="flex items-center">
                    <a href="{{ route('customer.tickets') }}" class="text-wwc-neutral-400 hover:text-wwc-neutral-600 mr-4">
                    ...
                    <div>
                        ...
                        <p class="text-wwc-neutral-600 mt-1">Ticket #{{ $ticket->id }}</p>
                    </div>
                </div>
                            ...
                            <div>
                                ...
                                <div class="space-y-3">
                                    <div>
                                        ...
                                        <p class="text-lg text-wwc-neutral-900 font-display">{{ $ticket->event->name }}</p>
                                    </div>
                                    <div>
                                        <p class="text-sm font-semibold text-wwc-neutral-600">Date & Time</p>
                                        <p class="text-wwc-neutral-900">{{ $ticket->event->date_time->format('M j, Y \a\t g:i A') }}</p>
                                    </div>
                                    <div>
                                        <p class="text-sm font-semibold text-wwc-neutral-600">Venue</p>
                                        <p class="text-wwc-neutral-900">{{ $ticket->event->venue ?? 'Venue TBA' }}</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <div class="space-y-3">
                                    <div>
                                        ...
                                        <p class="text-2xl font-bold text-wwc-primary font-display">{{ $ticket->seat_identifier }}</p>
                                    </div>
                                    <div>
                                        <p class="text-sm font-semibold text-wwc-neutral-600">Price Zone</p>
                                        <p class="text-wwc-neutral-900">{{ $ticket->seat->price_zone }}</p>
                                    </div>
                                    <div>
                            ...
                            <div>
                                ...
                                <div class="space-y-3">
                                    <div>
                                        ...
                                        <p class="text-wwc-neutral-900 font-mono">{{ $ticket->order->order_number }}</p>
                                    </div>
                                    <div>
                                        <p class="text-sm font-semibold text-wwc-neutral-600">Purchase Date</p>
                                        <p class="text-wwc-neutral-900">{{ $ticket->order->created_at->format('M j, Y \a\t g:i A') }}</p>
                                    </div>
                                    <div>
                                        <p class="text-sm font-semibold text-wwc-neutral-600">Payment Method</p>
                                        <p class="text-wwc-neutral-900">{{ $ticket->order->payment_method }}</p>
                                    </div>
                                </div>
                            </div>
                            <div>
                                ...
                                <div class="space-y-3">
                                    <div>
                                        ...
                                        <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-semibold
                                            @if($ticket->order->status === 'Completed') bg-wwc-success text-white
                                            @elseif($ticket->order->status === 'Pending') bg-wwc-warning text-white
                                            @elseif($ticket->order->status === 'Cancelled') bg-wwc-error text-white

<?php $__env->startSection('title', 'Purchase Details - ' . $purchase->id); ?>
                            ...
                            <div class="space-y-4">
                                ...
                                <div class="flex items-center py-3 border-b border-wwc-neutral-100">
                                    ...
                                    <div class="flex-1 flex items-center justify-between">
                                        ...
                                        <span class="text-base font-medium text-wwc-neutral-900"><?php echo e($purchase->id); ?></span>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-center py-3 border-b border-wwc-neutral-100">
                                    ...
                                    <div class="flex-1 flex items-center justify-between">
                                        ...
                                        <span class="text-base font-medium text-wwc-neutral-900"><?php echo e($purchase->ticketType->name ?? 'N/A'); ?></span>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-center py-3 border-b border-wwc-neutral-100">
                                    ...
                                    <div class="flex-1 flex items-center justify-between">
                                        ...
                                        <span class="text-base font-medium text-wwc-neutral-900"><?php echo e($purchase->event->name ?? 'N/A'); ?></span>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-center py-3 border-b border-wwc-neutral-100">
                                    ...
                                    <div class="flex-1 flex items-center justify-between">
                                        ...
                                        <span class="text-base font-medium text-wwc-neutral-900"><?php echo e($purchase->order->user->name ?? 'N/A'); ?></span>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-center py-3 border-b border-wwc-neutral-100">
                                    ...
                                    <div class="flex-1 flex items-center justify-between">
                                        ...
                                        <span class="text-base font-medium text-wwc-neutral-900">RM<?php echo e(number_format($purchase->price_paid, 2)); ?></span>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-center py-3 border-b border-wwc-neutral-100">
                                    ...
                                    <div class="flex-1 flex items-center justify-between">
                                        ...
                                        <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium
                                            ...
                                            <?php elseif($purchase->status === 'sold'): ?> bg-blue-100 text-blue-800
                                ...
                                <div class="flex items-center py-3 border-b border-wwc-neutral-100">
                                    ...
                                    <div class="flex-1 flex items-center justify-between">
                                        ...
                                        <span class="text-base font-medium text-wwc-neutral-900"><?php echo e($purchase->created_at->format('M d, Y H:i')); ?></span>
                                    </div>
                                </div>

                                <!-- QR Code -->
                                <?php if($purchase->qr_code): ?>
                                <div class="flex items-center py-3">
                                    ...
                                    <div class="flex-1">
                                        ...
                                        <p class="text-xs text-wwc-neutral-500 mt-1"><?php echo e($purchase->qr_code); ?></p>
                                    </div>
                                </div>
                                <?php endif; ?>
                            </div>
                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-white rounded-2xl shadow-sm border border-wwc-neutral-200">
                        ...
                        <div class="p-6 space-y-4">
                            <div class="flex items-center justify-between">
                                ...
                                <span class="text-base font-medium text-wwc-neutral-900"><?php echo e($purchase->order->order_number ?? 'N/A'); ?></span>
                            </div>
                            <div class="flex items-center justify-between">
                                <div class="flex items-center space-x-3">
                                    <div class="h-8 w-8 rounded-lg bg-green-100 flex items-center justify-center">
                                ...
                                <span class="inline-flex items-center px-2 py-1 rounded-full text-xs font-semibold
                                    <?php if(($purchase->order->status ?? '') === 'paid'): ?> bg-green-100 text-green-800
                                    <?php elseif(($purchase->order->status ?? '') === 'pending'): ?> bg-yellow-100 text-yellow-800
                                    <?php elseif(($purchase->order->status ?? '') === 'cancelled'): ?> bg-red-100 text-red-800
                                    <?php elseif(($purchase->order->status ?? '') === 'refunded'): ?> bg-gray-100 text-gray-800
                                    <?php else: ?> bg-gray-100 text-gray-800
                                    <?php endif; ?>">
                                    <?php echo e(ucwords($purchase->order->status ?? 'N/A')); ?>
                            ...
                            <div class="flex items-center justify-between">
                                ...
                                <span class="text-base font-medium text-wwc-neutral-900"><?php echo e($purchase->order->payment_method ? ucwords(str_replace('_', ' ', $purchase->order->payment_method)) : 'N/A'); ?></span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-2xl shadow-sm border border-wwc-neutral-200">
                        ...
                        <div class="p-6 space-y-4">
                            ...
                            <div class="flex items-center justify-between">
                                ...
                                <span class="text-base font-medium text-wwc-neutral-900"><?php echo e($purchase->order->user->email ?? 'N/A'); ?></span>
                            </div>
                            <?php if($purchase->order->user->phone ?? null): ?>
                            <div class="flex items-center justify-between">
                                <div class="flex items-center space-x-3">
                                    <div class="h-8 w-8 rounded-lg bg-purple-100 flex items-center justify-center">
                                ...
                                <span class="text-base font-medium text-wwc-neutral-900"><?php echo e($purchase->order->user->phone); ?></span>
                            </div>
                            <?php endif; ?>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-2xl shadow-sm border border-wwc-neutral-200">
                        ...
                        <div class="p-6 space-y-3">
                            <a href="<?php echo e(route('admin.orders.show', $purchase->order)); ?>" 
                            ...
                            <a href="<?php echo e(route('admin.users.show', $purchase->order->user)); ?>" 
                            ...
                            <a href="<?php echo e(route('admin.events.show', $purchase->event)); ?>" 

        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
            <div class="flex items-center justify-between">
                ...
                <div class="text-center flex-1 mx-8">
                    <h1 class="text-3xl font-bold text-wwc-neutral-900 font-display mb-1"><?php echo e($event->name); ?></h1>
                ...
                <div class="flex items-center">
                    <span class="inline-flex items-center px-4 py-2 rounded-lg text-sm font-semibold
                        <?php if($event->status === 'on_sale'): ?> bg-wwc-success/10 text-wwc-success border border-wwc-success/20
                        <?php elseif($event->status === 'sold_out'): ?> bg-wwc-error/10 text-wwc-error border border-wwc-error/20
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-12">
            ...
            <div class="lg:col-span-2">
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-wwc-neutral-200 p-8">
                    ...
                    <!-- Action Button -->
                    <?php if($event->status === 'on_sale' && $availabilityStats['tickets_available'] > 0): ?>
                    ...
                    <?php elseif($event->status === 'sold_out' || $availabilityStats['tickets_available'] <= 0): ?>
                    <div class="text-center">

...
<?php $__env->startSection('page-title', 'Purchase Details'); ?>
                            ...
                            <div class="space-y-4">
                                ...
                                <div class="flex items-center py-3 border-b border-wwc-neutral-100">
                                    ...
                                    <div class="flex-1 flex items-center justify-between">
                                        ...
                                        <div class="flex items-center space-x-2">
                                            <span class="text-base font-medium text-wwc-neutral-900 font-mono"><?php echo e($purchase->qrcode); ?></span>
                                            <button type="button" onclick="copyToClipboard('<?php echo e($purchase->qrcode); ?>')" 
                                ...
                                <div class="flex items-center py-3 border-b border-wwc-neutral-100">
                                    ...
                                    <div class="flex-1 flex items-center justify-between">
                                        ...
                                        <div class="text-right">
                                            <div class="text-base font-medium text-wwc-neutral-900"><?php echo e($purchase->order->user->name); ?></div>
                                            <div class="text-sm text-wwc-neutral-500"><?php echo e($purchase->order->user->email); ?></div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-center py-3 border-b border-wwc-neutral-100">
                                    ...
                                    <div class="flex-1 flex items-center justify-between">
                                        ...
                                        <div class="text-right">
                                            <div class="text-base font-medium text-wwc-neutral-900"><?php echo e($purchase->event->name); ?></div>
                                            <div class="text-sm text-wwc-neutral-500"><?php echo e($purchase->event->date_time->format('M d, Y H:i')); ?></div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-center py-3 border-b border-wwc-neutral-100">
                                    ...
                                    <div class="flex-1 flex items-center justify-between">
                                        ...
                                        <div class="text-right">
                                            <div class="text-base font-medium text-wwc-neutral-900"><?php echo e($purchase->ticketType->name ?? 'N/A'); ?></div>
                                ...
                                <div class="flex items-center py-3 border-b border-wwc-neutral-100">
                                    ...
                                    <div class="flex-1 flex items-center justify-between">
                                        ...
                                        <div class="text-right">
                                            <div class="text-base font-medium text-wwc-neutral-900">RM<?php echo e(number_format($purchase->price_paid, 2)); ?></div>
                                            <?php if($purchase->discount_amount > 0): ?>
                                                <div class="text-sm text-green-600">-RM<?php echo e(number_format($purchase->discount_amount, 2)); ?> discount</div>
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-center py-3 border-b border-wwc-neutral-100">
                                    ...
                                    <div class="flex-1 flex items-center justify-between">
                                        ...
                                        <span class="text-base font-medium text-wwc-neutral-900"><?php echo e($purchase->created_at->format('M d, Y H:i:s')); ?></span>
                                    </div>
                                </div>

                                <?php if($purchase->scanned_at): ?>
                                <!-- Scanned Date -->
                                <div class="flex items-center py-3 border-b border-wwc-neutral-100">
                                    <div class="flex-shrink-0 mr-4">
                                        <div class="h-8 w-8 rounded-lg bg-green-100 flex items-center justify-center">
                                    ...
                                    <div class="flex-1 flex items-center justify-between">
                                        ...
                                        <span class="text-base font-medium text-wwc-neutral-900"><?php echo e($purchase->scanned_at->format('M d, Y H:i:s')); ?></span>
                                    </div>
                                </div>
                                <?php endif; ?>

                                <?php if($purchase->event_day): ?>
                                <!-- Event Day -->
                                <div class="flex items-center py-3 border-b border-wwc-neutral-100">
                                    <div class="flex-shrink-0 mr-4">
                                    ...
                                    <div class="flex-1 flex items-center justify-between">
                                        ...
                                        <span class="text-base font-medium text-wwc-neutral-900"><?php echo e($purchase->event_day_name ?: \Carbon\Carbon::parse($purchase->event_day)->format('M j, Y')); ?></span>
                                    </div>
                                </div>
                                <?php endif; ?>

                                <?php if($purchase->combo_group_id): ?>
                                <!-- Combo Group ID -->
                                <div class="flex items-center py-3">
                                    ...
                                    <div class="flex-1 flex items-center justify-between">
                                        ...
                                        <span class="text-base font-medium text-wwc-neutral-900 font-mono"><?php echo e($purchase->combo_group_id); ?></span>
                                    </div>
                                </div>
                                <?php endif; ?>
                            </div>
                    ...
                    <div class="bg-white rounded-2xl shadow-sm border border-wwc-neutral-200 mb-6">
                        ...
                        <div class="p-6">
                            <div class="space-y-4">
                                <div>
                                    <div class="flex justify-between text-sm font-semibold mb-2">
                                        ...
                                        <span class="text-wwc-neutral-900">RM<?php echo e(number_format($purchase->original_price, 2)); ?></span>
                                    </div>
                                ...
                                <div>
                                    <div class="flex justify-between text-sm font-semibold mb-2">
                                        ...
                                        <span class="text-green-600">-RM<?php echo e(number_format($purchase->discount_amount, 2)); ?></span>
                                    </div>
                                    <div class="w-full bg-wwc-neutral-200 rounded-full h-2">
                                        <div class="bg-green-500 h-2 rounded-full" style="width: <?php echo e(($purchase->discount_amount / $purchase->original_price) * 100); ?>%"></div>
                                    </div>
                                </div>
                                <?php endif; ?>
                                ...
                                <div>
                                    <div class="flex justify-between text-sm font-semibold mb-2">
                                        ...
                                        <span class="text-wwc-neutral-900">RM<?php echo e(number_format($purchase->price_paid, 2)); ?></span>
                                    </div>
                                    <div class="w-full bg-wwc-neutral-200 rounded-full h-2">
                                        <div class="bg-wwc-success h-2 rounded-full" style="width: <?php echo e(($purchase->price_paid / $purchase->original_price) * 100); ?>%"></div>
                                    </div>
                                </div>
                                ...
                                <div class="pt-2 border-t border-wwc-neutral-200">
                                    <div class="text-center">
                                        <div class="text-lg font-bold text-green-600"><?php echo e(number_format(($purchase->discount_amount / $purchase->original_price) * 100, 1)); ?>%</div>
                            ...
                            <div class="mt-6 pt-4 border-t border-wwc-neutral-200">
                                <div class="text-center">
                                    <div class="text-3xl font-bold text-wwc-neutral-900 font-display">RM<?php echo e(number_format($purchase->price_paid, 0)); ?></div>
                    ...
                    <div class="bg-white rounded-2xl shadow-sm border border-wwc-neutral-200">
                        ...
                        <div class="p-6">
                            <div class="space-y-3">
                                ...
                                <form action="<?php echo e(route('admin.purchases.mark-scanned', $purchase)); ?>" method="POST" class="w-full">
                                    <?php echo csrf_field(); ?>
                                    <button type="submit" 
                                ...
                                <form action="<?php echo e(route('admin.purchases.cancel', $purchase)); ?>" method="POST" class="w-full">
                                    <?php echo csrf_field(); ?>
                                    <button type="submit" 
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/administrator/Desktop/Project/Github/warzone-ticketing-system/resources/views/admin/purchases/show.blade.php ENDPATH**/ ?>
<?php $__env->startSection('title', 'Cart - ' . $event->name); ?>
        ...
        <div class="max-w-md w-full mx-4">
            <div class="bg-white rounded-2xl shadow-lg border border-wwc-neutral-200 p-8">
                ...
                <form action="<?php echo e(route('login')); ?>" method="POST" class="space-y-4">
                    <?php echo csrf_field(); ?>
                    <input type="hidden" name="intended" value="<?php echo e(route('public.tickets.cart', $event)); ?>">
                ...
                <div class="text-center mt-6">
                    <p class="text-gray-600">Don't have an account? 
                        <a href="<?php echo e(route('register')); ?>" class="text-wwc-primary hover:text-wwc-primary-dark font-semibold">Register here</a>
                    </p>
                </div>
            </div>
        </div>
    ...
    <div class="min-h-screen bg-gray-50 py-8">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="space-y-6">
                ...
                <div class="bg-white rounded-2xl shadow-lg border border-gray-200 overflow-hidden hover:shadow-xl transition-all duration-300">
                    <div class="bg-red-600 px-8 py-6">
                        <div class="flex items-center">
                            ...
                            <div class="flex-1">
                                <h2 class="text-2xl font-bold text-white mb-1"><?php echo e($event->name); ?></h2>
                ...
                <form action="<?php echo e(route('public.tickets.purchase', $event)); ?>" method="POST" id="ticket-form" class="space-y-6">
                    <?php echo csrf_field(); ?>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div class="relative group">
                                    <input type="radio" 
                                           ...
                                           value="single_day" 
                                           class="sr-only peer"
                                           <?php echo e(old('purchase_type', 'single_day') == 'single_day' ? 'checked' : ''); ?>>
                                ...
                                <div class="relative group">
                                    <input type="radio" 
                                           ...
                                           value="multi_day" 
                                           class="sr-only peer"
                                           <?php echo e(old('purchase_type') == 'multi_day' ? 'checked' : ''); ?>>
                                    <label for="multi_day" 
                                           class="flex flex-col p-5 border-2 border-gray-200 rounded-xl cursor-pointer peer-checked:border-wwc-primary peer-checked:bg-wwc-primary/5 hover:border-wwc-primary/50 hover:shadow-md transition-all duration-200">
                                        <div class="flex items-center mb-3">
                                        ...
                                        <?php if($event->combo_discount_enabled && $event->combo_discount_percentage > 0): ?>
                                            <div class="flex items-center text-xs text-white bg-gradient-to-r from-green-500 to-green-600 px-3 py-1 rounded-lg font-semibold mt-3">
                                                ...
                                                <span><?php echo e($event->combo_discount_percentage); ?>% discount applied</span>
                                            </div>
                                        <?php endif; ?>
                                    </label>
                                </div>
                        ...
                        <div class="p-8 space-y-6">
                            ...
                            <div class="space-y-4">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <?php $__currentLoopData = $event->getEventDays(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $day): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="relative group">
                                        <input type="radio" 
                                               id="single_day<?php echo e($index + 1); ?>" 
                                               name="single_day_selection" 
                                               value="day<?php echo e($index + 1); ?>"
                                               class="sr-only peer"
                                               <?php echo e(old('single_day_selection', 'day1') == 'day' . ($index + 1) ? 'checked' : ''); ?>>
                                        <label for="single_day<?php echo e($index + 1); ?>" 
                                            ...
                                            <div class="flex items-center">
                                                <div class="w-6 h-6 rounded-full border-2 border-gray-300 peer-checked:border-wwc-primary peer-checked:bg-wwc-primary flex items-center justify-center transition-all duration-200" id="single_day<?php echo e($index + 1); ?>_radio">
                                                    <div class="w-4 h-4 rounded-full bg-white opacity-0 peer-checked:opacity-100 transition-opacity duration-200 shadow-lg" id="single_day<?php echo e($index + 1); ?>_dot"></div>
                                                </div>
                                                <div class="ml-3">
                                                    <h4 class="text-base text-gray-900">
                                                        <span class="font-bold"><?php echo e($day['day_name']); ?></span> | <span class="font-normal"><?php echo e($day['display']); ?></span>
                                                    </h4>
                                                </div>
                                            </div>
                                        </label>
                            ...
                            <div class="space-y-3">
                                ...
                                <div class="relative">
                                    <select id="ticket_type_id" name="ticket_type_id" required
                                            class="w-full px-3 py-2 border-2 border-gray-200 rounded-lg focus:ring-2 focus:ring-wwc-primary focus:border-wwc-primary <?php $__errorArgs = ['ticket_type_id'];
...
unset($__errorArgs, $__bag); ?> text-sm bg-white shadow-sm transition-all duration-200 hover:border-gray-300">
                                        ...
                                        <?php $__currentLoopData = $event->tickets->where('available_seats', '>', 0); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ticket): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <option value="<?php echo e($ticket->id); ?>" 
                                                ...
                                                <?php echo e($ticket->name); ?> - RM<?php echo e(number_format($ticket->price, 2)); ?> 
                                                <?php if($event->isMultiDay()): ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div id="multi_day_selection" class="bg-white rounded-2xl shadow-lg border border-gray-200 overflow-hidden hover:shadow-xl transition-all duration-300 hidden">
                        ...
                        <div class="p-8 space-y-6">
                            ...
                            <div class="space-y-4">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    ...
                                    <div class="relative group">
                                        <input type="checkbox" 
                                               id="multi_day<?php echo e($index + 1); ?>_enabled" 
                                               name="multi_day<?php echo e($index + 1); ?>_enabled" 
                                               value="1"
                                               class="sr-only peer day-checkbox"
                                               data-day="<?php echo e($index + 1); ?>">
                                        <label for="multi_day<?php echo e($index + 1); ?>_enabled" 
                                               class="flex flex-col p-5 border-2 border-gray-200 rounded-xl cursor-pointer peer-checked:border-wwc-primary peer-checked:bg-red-50 hover:border-wwc-primary/50 hover:shadow-md transition-all duration-200">
                                            <div class="flex items-center">
                                                <div class="w-6 h-6 rounded-full border-2 border-gray-300 peer-checked:border-wwc-primary peer-checked:bg-wwc-primary flex items-center justify-center transition-all duration-200" id="multi_day<?php echo e($index + 1); ?>_radio">
                                                    <div class="w-4 h-4 rounded-full bg-white opacity-0 peer-checked:opacity-100 transition-opacity duration-200 shadow-lg" id="multi_day<?php echo e($index + 1); ?>_dot"></div>
                                                </div>
                                                <div class="ml-3">
                                                    <h4 class="text-base text-gray-900">
                                                        <span class="font-bold"><?php echo e($day['day_name']); ?></span> | <span class="font-normal"><?php echo e($day['display']); ?></span>
                        ...
                        <div>
                            ...
                            <?php $__currentLoopData = $event->getEventDays(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $day): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div id="day<?php echo e($index + 1); ?>_ticket_section" class="border-2 border-gray-100 rounded-xl p-6 bg-gradient-to-br from-gray-50 to-white hover:shadow-md transition-all duration-200 hidden">
                        ...
                        <div>
                                            <h3 class="text-lg font-bold text-gray-900"><?php echo e($day['day_name']); ?> : <?php echo e($day['display']); ?></h3>
                                        </div>
                                    </div>
                        </div>
                                <div class="space-y-6">
                                    ...
                                    <div class="space-y-3">
                                        <label for="day<?php echo e($index + 1); ?>_ticket_type" class="block text-sm font-semibold text-gray-900">
                                            Select Ticket Type <span class="text-red-500">*</span>
                            </label>
                                        <div class="relative">
                                            <select id="day<?php echo e($index + 1); ?>_ticket_type" 
                                                    name="day<?php echo e($index + 1); ?>_ticket_type" 
                                    ...
                                    <div class="space-y-3">
                                        <label for="day<?php echo e($index + 1); ?>_quantity" class="block text-sm font-semibold text-gray-900">
                                            Quantity <span class="text-red-500">*</span>
                                        </label>
                                        <div class="flex items-center justify-center space-x-3">
                                            <button type="button" 
                                            ...
                                            <input type="number" 
                                                   id="day<?php echo e($index + 1); ?>_quantity" 
                                                   name="day<?php echo e($index + 1); ?>_quantity" 
                                                   value="1" 
                                                   min="1" 
                                                   max="10" 
                            ...
                            <div class="space-y-2 pt-4 border-t border-gray-300">
                                ...
                                <div class="flex items-center justify-between py-1">
                                    <div class="flex items-center">
                                        ...
                                        <span class="text-gray-700 font-medium text-sm">Combo Discount (<?php echo e($event->combo_discount_percentage); ?>%)</span>
                                    </div>
                                ...
                                <div class="flex items-center justify-between py-1">
                                    <div class="flex items-center">
                                        ...
                                        <span class="text-gray-700 font-medium text-sm">Service Fee (<?php echo e($serviceFeePercentage); ?>%)</span>
                                    </div>
                                ...
                                <div class="flex items-center justify-between py-1">
                                    <div class="flex items-center">
                                        ...
                                        <span class="text-gray-700 font-medium text-sm">Tax (<?php echo e($taxPercentage); ?>%)</span>
                                    </div>
...
const eventData = {
    ...
    serviceFeePercentage: <?php echo e($serviceFeePercentage); ?>,
    taxPercentage: <?php echo e($taxPercentage); ?>
...
function updateFormData() {
    ...
    document.getElementById('customer_name_input').value = '<?php echo e(Auth::user()->name ?? "Customer"); ?>';
    document.getElementById('customer_email_input').value = '<?php echo e(Auth::user()->email ?? "customer@example.com"); ?>';
    document.getElementById('customer_phone_input').value = '<?php echo e(Auth::user()->phone ?? ""); ?>';
}

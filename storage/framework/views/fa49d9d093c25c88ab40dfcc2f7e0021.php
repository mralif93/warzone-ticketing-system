...
<?php $__env->startSection('description', 'Sign in to your Warzone World Championship account to access your tickets and manage your profile.'); ?>
...
<?php $__env->startSection('title', 'Sign In'); ?>
<?php $__env->startSection('description', 'Sign in to your Warzone World Championship account to purchase tickets and manage your profile.'); ?>
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative">
                            ...
                            <input type="password" 
                                   id="password" 
                                   name="password"
                                   class="block w-full pl-12 pr-12 py-4 border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-wwc-primary focus:border-wwc-primary transition-all duration-200 bg-gray-50 focus:bg-white focus:caret-wwc-primary <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-300 focus:border-red-500 focus:ring-red-500 <?php unset($message);
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.public', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
<?php echo $__env->make('layouts.public', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/administrator/Desktop/Project/Github/warzone-ticketing-system/resources/views/auth/login.blade.php ENDPATH**/ ?>
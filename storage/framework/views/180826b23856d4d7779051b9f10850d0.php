        ...
        <div class="mx-auto">
            ...
            <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4 mb-6">
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-wwc-neutral-200 p-4">
                    <div class="flex items-center justify-between">
                        <div>
                            <div class="text-2xl font-bold text-wwc-neutral-900 mb-1"><?php echo e($users->whereIn('role', ['gate_staff', 'counter_staff', 'support_staff'])->count()); ?></div>
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-wwc-neutral-200 mb-6">
                ...
                <div class="p-6">
                    ...
                    <div>
                            ...
                            <option value="gate_staff" <?php echo e(request('role') == 'gate_staff' ? 'selected' : ''); ?>>Gate Staff</option>
                            <option value="counter_staff" <?php echo e(request('role') == 'counter_staff' ? 'selected' : ''); ?>>Counter Staff</option>
                            <option value="support_staff" <?php echo e(request('role') == 'support_staff' ? 'selected' : ''); ?>>Support Staff</option>
                                ...
                                <tr class="hover:bg-wwc-neutral-50 transition-colors duration-150">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <span class="px-2.5 py-0.5 rounded-full text-xs font-semibold
                                            ...
                                            <?php elseif($user->role === 'gate_staff'): ?> bg-green-100 text-green-800
                                            <?php elseif($user->role === 'counter_staff'): ?> bg-blue-100 text-blue-800
